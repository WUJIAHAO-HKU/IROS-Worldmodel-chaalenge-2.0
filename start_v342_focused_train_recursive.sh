...
run="artifacts/strict_track2_joint_augmentation_20260810/v342_focused_train_recursive_seed1511_20260822"
...
/root/miniconda3/envs/go1/bin/python pipeline/scripts/prepare_v342_focused_train_recursive.py
exec taskset -c 0-7 /root/miniconda3/envs/go1/bin/python \
  pipeline/scripts/audit_v342_focused_train_recursive.py \
