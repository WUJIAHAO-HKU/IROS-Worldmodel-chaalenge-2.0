...
run="artifacts/strict_track2_joint_augmentation_20260810/v343_v342_public_holdout_recursive_seed1512_20260822"
v339="artifacts/strict_track2_joint_augmentation_20260810/v339_high_specificity_recursive_ood_gate_seed1508_20260822"
v342="artifacts/strict_track2_joint_augmentation_20260810/v342_focused_train_recursive_seed1511_20260822"
...
/root/miniconda3/envs/go1/bin/python pipeline/scripts/prepare_v343_v342_public_holdout_recursive.py
exec taskset -c 0-7 /root/miniconda3/envs/go1/bin/python \
  pipeline/scripts/audit_v343_v342_public_holdout_recursive.py \
  ...
  --v342-train-report "$v342/focused_train_gate_report.json" \
