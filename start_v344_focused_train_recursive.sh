...
run="artifacts/strict_track2_joint_augmentation_20260810/v344_focused_train_recursive_seed1513_20260822"
...
if [[ ! -f "$run/release_registration.json" ]]; then
  /root/miniconda3/envs/go1/bin/python pipeline/scripts/prepare_v344_focused_train_recursive.py
fi
exec taskset -c 0-7 /root/miniconda3/envs/go1/bin/python \
  pipeline/scripts/audit_v344_focused_train_recursive.py \
