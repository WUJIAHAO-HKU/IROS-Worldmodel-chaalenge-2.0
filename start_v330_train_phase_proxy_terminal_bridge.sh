...
RUN="$J/v330_train_phase_proxy_terminal_bridge_seed1500_20260822"
cd "$R"
...
taskset -c 0-7 "$PY" pipeline/scripts/sweep_v330_train_phase_proxy_terminal_bridge.py \
...
printf 'V330_TRAIN_PHASE_PROXY_SWEEP_COMPLETED\n'
