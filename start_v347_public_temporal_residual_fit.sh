...
run="artifacts/strict_track2_joint_augmentation_20260810/v347_public_temporal_residual_fit_seed1516_20260822"
...
if [[ ! -f "$run/release_registration.json" ]]; then
  /root/miniconda3/envs/go1/bin/python pipeline/scripts/prepare_v347_public_temporal_residual_fit.py
fi
