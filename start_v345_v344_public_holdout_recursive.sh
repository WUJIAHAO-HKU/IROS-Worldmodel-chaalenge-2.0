...
run="artifacts/strict_track2_joint_augmentation_20260810/v345_v344_public_holdout_recursive_seed1514_20260822"
v339="artifacts/strict_track2_joint_augmentation_20260810/v339_high_specificity_recursive_ood_gate_seed1508_20260822"
v344="artifacts/strict_track2_joint_augmentation_20260810/v344_focused_train_recursive_seed1513_20260822"
...
if [[ ! -f "$run/release_registration.json" ]]; then
  /root/miniconda3/envs/go1/bin/python pipeline/scripts/prepare_v345_v344_public_holdout_recursive.py
fi
exec taskset -c 0-7 /root/miniconda3/envs/go1/bin/python \
  pipeline/scripts/audit_v345_v344_public_holdout_recursive.py \
  ...
  --v344-train-report "$v344/focused_train_gate_report.json" \
