#!/usr/bin/env python3
"""Sole launcher for the v540 public-S1 plus zero-update gate boundary."""
...
SEED=1671
PATHS={
 "contract":"/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/v540_v539_public_s1_zero_update_poststage_owned_output_prep_repair_execution_authority_contract.json",
 "preregistration":"/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/v540_v539_public_s1_zero_update_poststage_owned_output_prep_repair_preregistration.json",
 "manifest":"/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/v540_v539_public_s1_zero_update_poststage_owned_output_prep_repair_manifest.json",
 "evaluator_source":"/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/evaluate_v540_v539_public_s1_zero_update_poststage_owned_output_prep_repair.py",
 "auditor_source":"/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/audit_v540_v539_public_s1_zero_update_poststage_owned_output_prep_repair.py",
 "launcher_source":"/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/launch_v540_v539_public_s1_zero_update_poststage_owned_output_prep_repair.py",
 "authority_receipt":"/root/autodl-tmp/IROS_WAM_2.0 challenge/artifacts/strict_track2_joint_augmentation_20260810/v540_v539_public_s1_zero_update_poststage_owned_output_prep_repair_execution_authority_seed1671_20260828/authority_receipt.json",
...
def run(argv=None):
 ...
 try:
  spec=importlib.util.spec_from_file_location("v540_public_s1_evaluator",args.evaluator_source); module=importlib.util.module_from_spec(spec); spec.loader.exec_module(module)
