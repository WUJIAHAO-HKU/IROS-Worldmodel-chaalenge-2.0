#!/usr/bin/env python3
"""Paired all-offset recursive gate of v424 versus frozen v209."""
...
def main():
    ...
    if json.loads(args.preregistration.read_text()).get("format")!="strict-track2-v425-v424-mirror-augmented-recursive-preregistration-v1": raise RuntimeError("wrong v425 preregistration")
    ...
    report={"format":"strict-track2-v425-v424-mirror-augmented-recursive-gate-v1","created_at":datetime.now(timezone.utc).isoformat(),
            "candidate":"v424 v202-left/v423-mirror-augmented-right learned parent","coverage":"512 public right holdout windows in 8 recursive alignment chains",
            "aggregates":aggregates,"v424_over_v209":comparisons,"checks":checks,"passed":passed,
    ...
    args.output.write_text(json.dumps(report,indent=2)+"\n"); print(json.dumps({"v424_over_v209":comparisons,"checks":checks,"passed":passed},indent=2),flush=True)
