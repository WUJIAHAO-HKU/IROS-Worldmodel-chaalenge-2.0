...
RUN="$J/v384_action_phase_clean_reanchor_seed1547_20260823"
...
taskset -c 0-7 "$PY" "$ROOT/pipeline/scripts/audit_v384_recursive_reward_causal.py" \
...
printf 'V384_RECURSIVE_COMPLETE\n'
