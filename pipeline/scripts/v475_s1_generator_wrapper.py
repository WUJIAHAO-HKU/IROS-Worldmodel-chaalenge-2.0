"""Frozen v475 S1 interface: ordered scalar v169 and one shared baseline per true/override pair."""
...
def predict_true_and_action_override(runtime,context,history,true_future,seeds,instructions,override_action_features):
 ...
 return {"same_request_v169":baseline,"v475_true":true,"v475_action_override":override,"true_decisions":decision,"override_decisions":override_decision}
