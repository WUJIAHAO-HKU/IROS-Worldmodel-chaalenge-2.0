...
SEED = 1670
FORMAT = "strict-track2-v539-v535-public-s1-zero-update-gate-execution-receipt-v1"
...
ACTIVE_SOURCE_PATHS = {
    "authority_design_contract": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/v539_v535_public_s1_zero_update_runtime_package_repair_execution_authority_contract.json",
    "authority_materializer": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/materialize_v539_v535_public_s1_zero_update_runtime_package_repair_execution_authority.py",
    "public_s1_zero_update_preregistration": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/v539_v535_public_s1_zero_update_gate_preregistration.json",
    "public_s1_zero_update_manifest": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/v539_v535_public_s1_zero_update_gate_manifest.json",
    "public_s1_evaluator": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/evaluate_v539_v535_public_s1_zero_update_gate.py",
    "public_s1_independent_auditor": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/audit_v539_v535_public_s1_zero_update_gate.py",
    "public_s1_launcher": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/launch_v539_v535_public_s1_zero_update_gate.py",
}
...
EXPECTED_HISTORICAL_ABSENCES={"attempt_prep":{"absent":True,"path":"/root/autodl-tmp/IROS_WAM_2.0 challenge/artifacts/strict_track2_joint_augmentation_20260810/v539_v535_public_s1_zero_update_gate_attempt_seed1670_20260828.attempt-prep"},"attempt_root":{"absent":True,"path":"/root/autodl-tmp/IROS_WAM_2.0 challenge/artifacts/strict_track2_joint_augmentation_20260810/v539_v535_public_s1_zero_update_gate_attempt_seed1670_20260828"},"authority_prep":{"absent":True,"path":"/root/autodl-tmp/IROS_WAM_2.0 challenge/artifacts/strict_track2_joint_augmentation_20260810/v539_v535_public_s1_zero_update_runtime_package_repair_execution_authority_seed1670_20260828.authority-prep"},"authority_root":{"absent":True,"path":"/root/autodl-tmp/IROS_WAM_2.0 challenge/artifacts/strict_track2_joint_augmentation_20260810/v539_v535_public_s1_zero_update_runtime_package_repair_execution_authority_seed1670_20260828"},"output_prep":{"absent":True,"path":"/root/v539_v535_public_s1_zero_update_gate_seed1670_20260828.output-prep"},"output_root":{"absent":True,"path":"/root/v539_v535_public_s1_zero_update_gate_seed1670_20260828"}}
...
def validate_documents(prereg, manifest, contract, authority, args, *, require_fresh: bool = True) -> None:
    if (set(prereg)!=PREREG_KEYS or set(manifest)!=MANIFEST_KEYS or set(contract)!=CONTRACT_KEYS
            or prereg.get("format")!="strict-track2-v539-v535-public-s1-zero-update-gate-preregistration-v1"
            or manifest.get("format")!="strict-track2-v539-v535-public-s1-zero-update-gate-manifest-v1"
            or contract.get("format")!="strict-track2-v539-v535-public-s1-zero-update-runtime-package-repair-execution-authority-design-contract-v1"
    ...
    if any(os.path.lexists(row["path"]) for row in EXPECTED_CURRENT_ABSENCES.values()): raise RuntimeError("current required absence present")
    for field in ("v534_actual_oof_durable_transition", "v535_failed_attempt_transition", "runtime_package_import_contract", "public_s1_input_contract", "public_s1_output_contract", "zero_update_contract", "hidden_input_denial_contract"):
    ...
    absence_values=(prereg["fresh_attempt_root"],prereg["fresh_attempt_prep_root"],prereg["fresh_output_root"])
    if require_fresh: absence_values=(*absence_values,prereg["fresh_output_prep_root"])
    if any(Path(value).exists() for value in absence_values):
        raise FileExistsError("fresh roots")
...
def execute(args) -> dict:
    ...
    try:
        prep.mkdir(mode=0o700); identity=prep.stat(); raw_rng=rng_capture_raw(); rng_entry=rng_snapshot()
        held_json(prep/"attempt_intent.json", {"format":"strict-track2-v539-v535-public-s1-zero-update-attempt-intent-v1","seed":SEED,"literal_argv":args.literal_argv,"rng_entry":rng_entry,"authority_receipt_sha256":args.authority_receipt_sha},held)
        ...
        validate_documents(prereg,manifest,contract,authority,args,require_fresh=False)
