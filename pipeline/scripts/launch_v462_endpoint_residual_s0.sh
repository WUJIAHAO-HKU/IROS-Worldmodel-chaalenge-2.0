#!/usr/bin/env bash
# Preregistered public-train v462 WM parent gate only. No reward, policy update, RL, dev/final, or submission.
set -euo pipefail
ROOT='/root/autodl-tmp/IROS_WAM_2.0 challenge'
J="$ROOT/artifacts/strict_track2_joint_augmentation_20260810"
V461="$J/v461_endpoint200_seed1612_20260823"
REG="$J/v462_endpoint_residual_seed1613_20260823"
TRAINING="$REG/training"
RELEASE="$J/v462_v169_endpoint_residual_parent_release"
RLPY='/root/autodl-tmp/conda_envs/rlinf_track2/bin/python'
PREP="$ROOT/pipeline/scripts/prepare_v462_endpoint_residual_5fold.py"
TRAINER="$ROOT/pipeline/scripts/train_v462_endpoint_residual_5fold.py"
PACKAGER="$ROOT/pipeline/scripts/package_v462_endpoint_residual_release.py"
RUNTIME="$ROOT/pipeline/wam_pipeline/v462_v169_endpoint_residual_runtime.py"
...
LOCK_FILE='/var/lock/v462_endpoint_residual_seed1613.lock'
...
test "$(sha256sum "$PREP" | awk '{print $1}')" = 'e42cca9ac90aeb9ede97504fcc26ff50f47f3644020e6615d1711bda00127206'
test "$(sha256sum "$TRAINER" | awk '{print $1}')" = '5c1521be60cb69b0d8379a1bde5f464cb4d08601d3421b860d26fffec693754a'
test "$(sha256sum "$PACKAGER" | awk '{print $1}')" = '668a60eeb6332a898dbd9d49600e16f8eaf38bda12ac379645dfc3805a0e614c'
test "$(sha256sum "$RUNTIME" | awk '{print $1}')" = '03dbffdddedc897bc5a2fe4126102162af2ae356c9cfd8ae4dda2503699b524d'
...
payload={'format':'strict-track2-v462-launcher-failure-receipt-v1','passed':False,'reason':reason,'exit_code':int(code),'wall_seconds':int(elapsed),'gpu_peak_mib':int(peak),'training_process_group':int(pid) if pid else None,'reward_loaded':False,'policy_updates':0,'rl_authorized':False}
tmp=path+'.tmp'
...
WATCHDOG_PID=''
trap - EXIT TERM INT
echo V462_ENDPOINT_RESIDUAL_S0_AND_ALL200_COMPLETE
