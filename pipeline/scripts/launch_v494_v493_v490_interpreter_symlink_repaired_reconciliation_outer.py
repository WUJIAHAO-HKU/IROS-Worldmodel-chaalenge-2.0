...
SELF_PATH=ROOT/"pipeline/scripts/launch_v494_v493_v490_interpreter_symlink_repaired_reconciliation_outer.py"
AUTH_CONTRACT=ROOT/"pipeline/scripts/v494_v493_v490_interpreter_symlink_repair_execution_authority_contract.json"
AUTH_ROOT=J/"v494_v493_v490_interpreter_symlink_repair_execution_authority_seed1636_20260825";AUTH_PREP=AUTH_ROOT.with_name(AUTH_ROOT.name+".registration-prep");AUTH_RECEIPT=AUTH_ROOT/"authority_receipt.json"
...
INNER_WRAPPER=ROOT/"pipeline/scripts/launch_v494_v493_v490_interpreter_symlink_repaired_reconciliation_inner.py";INNER_WRAPPER_SHA="1f2c9de60703f12c22966b7aeb3526a6c32e0d5a0e0258094c9d208b9a56f4bf";INNER_WRAPPER_BYTES=79760
...
INNER_ATTEMPT=J/"v494_v493_v490_interpreter_symlink_repaired_reconciliation_inner_attempt_seed1636_20260825";INNER_PREP=INNER_ATTEMPT.with_name(INNER_ATTEMPT.name+".attempt-prep")
TRANSPARENT=F813.parent/"transparent_static_audit.json";TRANSPARENT_TMP=TRANSPARENT.with_name(TRANSPARENT.name+".tmp")
OUTER_EVIDENCE=J/"v494_v493_v490_interpreter_symlink_repaired_reconciliation_outer_execution_evidence_seed1636_20260825";OUTER_PREP=OUTER_EVIDENCE.with_name(OUTER_EVIDENCE.name+".outer-prep")
QUALIFICATION=Path("/root/v485_v169_cache_qualification_seed1627_20260824")
AUTH_FORMAT="strict-track2-v494-v493-v490-interpreter-symlink-repair-execution-authority-v1";AUTH_STATUS="authorized_exact_one_external_v494_interpreter_symlink_repaired_outer_attempt"
CONTRACT_FORMAT="strict-track2-v494-v493-v490-interpreter-symlink-repair-execution-authority-design-contract-v1";CONTRACT_STATUS="design_only_frozen_sources_pending_independent_review_no_authority"
OUTER_INTENT_FORMAT="strict-track2-v494-v493-v490-interpreter-symlink-repaired-reconciliation-outer-attempt-intent-v1";OUTER_TERMINAL_FORMAT="strict-track2-v494-v493-v490-interpreter-symlink-repaired-reconciliation-outer-attempt-terminal-v1"
...
SOURCE_ROLES={"v493_authority_contract","v493_authority_materializer","v493_outer_wrapper","v493_inner_wrapper","corrected_inner_wrapper","reconciler_r2","outer_execution_wrapper","phase_a_design_contract"}
...
AUTH_KEYSET_SHA="b67e7b6baf1e063e4564aaec20220cc68051da3b65f83e12a011e937968908f3";AUTH_CHECKS_SHA="d3440bf3824f5931be02120d3eeb5a0f20be20e3991efaff33b4d7809bbf9554"
...
def authority_preflight(args):
 ...
 if set(contract)!=CONTRACT_TOP_KEYS or contract.get("format")!=CONTRACT_FORMAT or contract.get("status")!=CONTRACT_STATUS or contract.get("seed")!=1636 or contract.get("execution_boundary")!=EXECUTION_BOUNDARY:raise RuntimeError("contract identity")
 ...
 historical=decode_absence_receipt(receipt.get("historical_absences"),27);required=decode_absence_receipt(receipt.get("required_absences"),26);contract_historical=decode_path_map(contract.get("historical_absences"),27);contract_current=decode_path_map(contract.get("current_absences_after_authority"),26)
...
def execute(args):
 ...
 try:
  ...
  if inner_terminal.get("format")!="strict-track2-v494-v493-v490-interpreter-symlink-repaired-reconciliation-inner-attempt-terminal-v1" or inner_terminal.get("status")!="passed_exact_one_corrected_inner_and_r2_readonly_reconciliation" or inner_terminal.get("passed") is not True or inner_terminal.get("reconciler_exit_code")!=0 or inner_terminal.get("f813_exact2_to_sole_exact3") is not True or inner_terminal.get("failed_v493_outer_execution_tree")!=context["failed_v493_tree"] or inner_terminal.get("failed_v493_outer_terminal_receipt")!=context["failed_v493_terminal"] or inner_terminal.get("execution_interpreter_evidence")!=context["execution_interpreter_evidence"]:raise RuntimeError("inner terminal")
...
def synthetic():
 ...
 fixture_path=Path("/dev/shm/v494_authority_contract_candidate.json")
 if fixture_path.is_file():
  fixture=json.loads(fixture_path.read_text());historical=decode_path_map(fixture["historical_absences"],27);current=decode_path_map(fixture["current_absences_after_authority"],26)
