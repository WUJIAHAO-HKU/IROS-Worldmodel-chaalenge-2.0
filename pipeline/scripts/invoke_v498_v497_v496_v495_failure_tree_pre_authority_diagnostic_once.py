...
SELF_PATH = SCRIPTS / "invoke_v498_v497_v496_v495_failure_tree_pre_authority_diagnostic_once.py"
TRANSPORT_SCRIPT_PATH = Path("/root/v498_pre_authority_diagnostic_once.sh")
DIAGNOSTIC_SOURCE = SCRIPTS / "diagnose_v498_v497_v496_v495_failure_tree_pre_authority.py"
DIAGNOSTIC_SOURCE_SHA = "328d88b9dd5c2268f27c612322785eeca3cfe053018b00512492f984f8332fe6"
DIAGNOSTIC_SOURCE_BYTES = 38424
...
def base_process_receipt(status: str, passed: bool, invocations: int, cleanup: dict,
    ...
    row = {"format": "strict-track2-v498-pre-authority-diagnostic-process-receipt-v1",
...
def orchestrate_once(*, evidence_root: Path, evidence_prep: Path, child_argv: list[str],
    ...
    try:
        ...
        atomic_json(evidence_prep / "intent.json", {
            "format": "strict-track2-v498-pre-authority-diagnostic-intent-v1",
...
def production_fixture() -> dict:
    checks = {}
    with tempfile.TemporaryDirectory(prefix="v498-helper-fixture-") as directory:
        base = Path(directory)
...
def main() -> int:
    ...
    argv = command()
    argv_payload = {"format": "strict-track2-v498-pre-authority-diagnostic-argv-v1",
