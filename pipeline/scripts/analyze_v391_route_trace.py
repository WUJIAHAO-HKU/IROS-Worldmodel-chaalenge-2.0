#!/usr/bin/env python3
"""Analyze the one-shot v390 policy-distribution preflight."""
...
def main() -> int:
    ...
    if prereg.get("format") != "strict-track2-v391-v169-v390-route-trace32-preregistration-v1":
        raise RuntimeError("wrong v391 preregistration")
    ...
    report = {
        "format": "strict-track2-v391-v390-route-trace-analysis-v1",
        ...
        "decision": "permit_one_conservative_rl_update" if passed else "reject_v390_before_rl",
