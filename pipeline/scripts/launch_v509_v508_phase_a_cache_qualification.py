#!/usr/bin/env python3
"""One-shot v509 Phase-A cache qualification launcher (design-only source).

The launcher consumes the fresh v509 authority, preserves the frozen v485
exact-seven execution closure through the fresh v509 driver, owns the driver
...
SEED = 1650
AUTHORITY_CONTRACT = SCRIPTS / "v509_v508_phase_a_wam_pipeline_import_repair_execution_authority_contract.json"
AUTHORITY_MATERIALIZER = SCRIPTS / "materialize_v509_v508_phase_a_wam_pipeline_import_repair_execution_authority.py"
AUTHORITY_MATERIALIZER_SHA = "f993b1a464995d84ecaac994bfc7f5630763feabdfcf40e791a0cb49b6a300ff"
AUTHORITY_MATERIALIZER_BYTES = 28224
SELF = SCRIPTS / "launch_v509_v508_phase_a_cache_qualification.py"
DRIVER = SCRIPTS / "generate_v509_v508_phase_a_cache_qualification.py"
DRIVER_SHA = "e481a4be0a2cdbccdfd9a3a26cfe0eb0b539460dcd18fb7e014d5291c71f5428"
DRIVER_BYTES = 37884
...
AUTHORITY_ROOT = J / "v509_v508_phase_a_wam_pipeline_import_repair_execution_authority_seed1650_20260825"
...
ATTEMPT_ROOT = J / "v509_v508_phase_a_cache_qualification_attempt_seed1650_20260825"
ATTEMPT_PREP = ATTEMPT_ROOT.with_name(ATTEMPT_ROOT.name + ".attempt-prep")
QUALIFICATION_ROOT = Path("/root/v509_v508_phase_a_cache_qualification_seed1650_20260825")
QUALIFICATION_PREP = QUALIFICATION_ROOT.with_name(QUALIFICATION_ROOT.name + ".attempt-prep")

PREREG = J / "v509_v508_phase_a_cache_qualification_prereg_seed1650_20260825/preregistration.json"
PREREG_SHA = "8200ba523295a607bbab47c897e83e0b8736ab6000dc26a37fe73c6363cd7cc4"
PREREG_BYTES = 56800
...
AUTHORITY_FORMAT = "strict-track2-v509-v508-phase-a-wam-pipeline-import-repair-execution-authority-v1"
AUTHORITY_STATUS = "authorized_exact_one_external_v509_phase_a_cache_qualification_attempt"
CONTRACT_FORMAT = "strict-track2-v509-v508-phase-a-wam-pipeline-import-repair-execution-authority-design-contract-v1"
CONTRACT_STATUS = "design_only_frozen_sources_pending_independent_review_no_authority"
INTENT_FORMAT = "strict-track2-v509-v508-phase-a-cache-qualification-attempt-intent-v1"
TERMINAL_FORMAT = "strict-track2-v509-v508-phase-a-cache-qualification-attempt-terminal-v1"
SOURCE_ORDER = [
    ...
    "wam_pipeline_package_tree_manifest",
    ...
    "restart_v218_source",
    "v508_authority_contract",
    "v508_authority_materializer",
    "v508_phase_a_launcher",
    "v508_authority_transport_helper",
    "v508_authority_transport_script",
    "v508_phase_a_transport_script",
    "v509_failure_forensic",
]
AUTHORIZATION = {
    ...
    "worker_pythonpath_injection_authorized": True,
    "worker_pythonpath_exact": str(ROOT / "pipeline"),
...
RUNTIME_PRE = {
    ...
    "worker_pythonpath_injected": False,
...
CHECK_KEYS = sorted({"contract_current","materializer_current","source_closure_current","source_order_exact","source_aliases_exact","fresh_prereg_mechanical_diff","fresh_prereg_exact7","wam_pipeline_manifest_current","wam_pipeline_tree_exact465","wam_pipeline_import_exact_env","wam_pipeline_double_snapshot_equal","worker_pythonpath_only","service_env_unchanged","v508_authority_exact1","v508_materialization_exact6","v508_materialization_process","v508_attempt_exact4","v508_terminal_failed_no_retry","v508_qualification_exact6","v508_failure_receipt","v508_process_a_completion","v508_failure_forensic_exact","old_sources_current","fresh_roots_absent","historical_absences","current_absences","input_snapshots_equal","publish_stable_excludes_authority_prep","no_live_phase_a_process","gpu_empty","authorization_boundary","execution_boundary","no_pending_values"})
CONTRACT_TOP_KEYS = {"format","status","seed","lineage","source_closure","source_role_order","source_aliases","source_closure_sha256","authority_materializer_source","phase_a_launcher_source","phase_a_driver_source","phase_a_preregistration_source","wam_pipeline_package_tree_manifest_source","wam_pipeline_package_tree","wam_pipeline_import_fixture","wam_pipeline_exact_worker_environment","driver_environment_contract","phase_a_design_contract_record","phase_a_static_audit_record","v508_authority_receipt","v508_authority_registration_tree","v508_materialization_evidence_tree","v508_materialization_process_receipt","v508_phase_a_attempt_tree","v508_phase_a_terminal_receipt","v508_qualification_tree","v508_qualification_failure_receipt","v508_process_a_completion_receipt","v508_failure_forensic","qualification_output_root","historical_absences","current_absences_after_authority","authority_receipt_contract","authorization","runtime_observation","execution_boundary"}
SOURCE_ALIASES = {"authority_design_contract":"authority_design_contract", **{role:role+"_source" for role in SOURCE_ORDER[1:]}}
AUTH_TOP_KEYS = {"format","status","passed","source_closure","source_role_order","source_aliases","source_closure_sha256",*SOURCE_ALIASES.values(),"wam_pipeline_package_tree","wam_pipeline_import_fixture","wam_pipeline_exact_worker_environment","driver_environment_contract","v508_authority_receipt","v508_authority_registration_tree","v508_materialization_evidence_tree","v508_materialization_process_receipt","v508_phase_a_attempt_tree","v508_phase_a_terminal_receipt","v508_qualification_tree","v508_qualification_failure_receipt","v508_process_a_completion_receipt","v508_failure_forensic","qualification_output_root","phase_a_attempt_root","historical_absences","required_absences","checks","check_keys","check_key_set_sha256","checks_sha256","input_pre_snapshot","input_post_snapshot","input_snapshots_exactly_equal","authorization","runtime_observation","execution_boundary","phase_a_cache_qualification_authorized","training_authorized","preregistration_sha256","contract_sha256"}
...
def validate_authority(args: argparse.Namespace) -> dict:
    ...
    required = {
        ...
        "wam_pipeline_package_tree_manifest": regular(PACKAGE_MANIFEST, PACKAGE_MANIFEST_SHA, PACKAGE_MANIFEST_BYTES),
    ...
    lineage = {
        "name": "v509_v508_phase_a_wam_pipeline_import_repair",
        ...
        "supersedes_v508_phase_a_failure_no_retry": True,
        "sole_semantic_change": "worker_popen_exact_pythonpath",
    }
    if (contract.get("lineage") != lineage or contract.get("authority_materializer_source") != closure["authority_materializer"]
            ...
            or contract.get("wam_pipeline_package_tree_manifest_source") != closure["wam_pipeline_package_tree_manifest"]):
        raise RuntimeError("v509 contract active lineage")
    if contract.get("authorization") != AUTHORIZATION or contract.get("runtime_observation") != RUNTIME_PRE or contract.get("execution_boundary") != authority.get("execution_boundary"):
        raise RuntimeError("v509 contract boundary")
    ...
    if authority.get("wam_pipeline_package_tree") != package or contract.get("wam_pipeline_package_tree") != package or authority.get("wam_pipeline_exact_worker_environment") != {"PYTHONPATH":str(ROOT/"pipeline")}:
        raise RuntimeError("wam_pipeline authority")
    environment_contract = authority.get("driver_environment_contract", {})
    if environment_contract.get("worker_environment_exact") != {"PYTHONPATH":str(ROOT/"pipeline")} or environment_contract.get("worker_popen_env_uses") != 2 or environment_contract.get("service_popen_env_uses") != 0 or any(environment_contract.get(key) is not False for key in ("service_environment_overrides_authorized","inherited_environment_authorized","appended_pythonpath_authorized","extra_environment_keys_authorized")):
        raise RuntimeError("worker environment boundary")
    forensic = json.loads(FAILURE_FORENSIC.read_text())
    if closure.get("v509_failure_forensic") != regular(FAILURE_FORENSIC, FAILURE_FORENSIC_SHA, FAILURE_FORENSIC_BYTES) or authority.get("v508_failure_forensic") != forensic or contract.get("v508_failure_forensic") != forensic:
        raise RuntimeError("v508 failure forensic")
    if forensic.get("status") != "v508_phase_a_failed_no_retry_process_a_import_error" or forensic.get("root_cause", {}).get("error") != "No module named 'wam_pipeline'" or forensic.get("authorization", {}).get("retry_v508_driver_authorized") is not False:
        raise RuntimeError("v508 failure semantics")
    for key in ("v508_authority_registration_tree","v508_materialization_evidence_tree","v508_phase_a_attempt_tree","v508_qualification_tree"):
        value=authority.get(key)
        if value != contract.get(key) or not isinstance(value,dict) or exact_tree(Path(value.get("root",""))) != value:raise RuntimeError(f"ancestry tree {key}")
    for key in ("v508_authority_receipt","v508_materialization_process_receipt","v508_phase_a_terminal_receipt","v508_qualification_failure_receipt","v508_process_a_completion_receipt"):
        value=authority.get(key)
        if value != contract.get(key) or not isinstance(value,dict) or regular(Path(value.get("path","")),value.get("sha256"),value.get("logical_bytes")) != value:raise RuntimeError(f"ancestry record {key}")
    terminal=json.loads(Path(authority["v508_phase_a_terminal_receipt"]["path"]).read_text());failure=json.loads(Path(authority["v508_qualification_failure_receipt"]["path"]).read_text());completion=json.loads(Path(authority["v508_process_a_completion_receipt"]["path"]).read_text())
    if terminal.get("status")!="failed_no_retry" or terminal.get("launcher_invocations")!=1 or terminal.get("nested_phase_a_driver_invocations")!=1 or terminal.get("retry_authorized") is not False or failure.get("status")!="failed_no_retry" or completion.get("exit_type")!="nonzero_exit" or completion.get("exit_code")!=1:raise RuntimeError("v508 no-retry partition")
    prereg = json.loads(PREREG.read_text())
    if prereg.get("execution_sources_digest_sha256") != "7912671a0ac69fbc15ff6bfc547d0e3810256e83cda76d7ef8f002c6cc846c75" or prereg.get("qualification_output_root") != str(QUALIFICATION_ROOT):
        raise RuntimeError("v509 exact7 digest/root")
    ...
    for record in records:
        if regular(Path(record["path"]), record["sha256"], record["logical_bytes"]) != {k: record[k] for k in ("path", "sha256", "logical_bytes")}:
            raise RuntimeError("v509 exact7 current")
    if prereg["execution_sources"].get("phase_a_driver") != closure["fresh_phase_a_driver"]:raise RuntimeError("fresh driver prereg")
...
def stable_snapshot(context: dict) -> dict:
    ...
    records.extend([regular(FAILURE_FORENSIC, FAILURE_FORENSIC_SHA, FAILURE_FORENSIC_BYTES),regular(PACKAGE_MANIFEST, PACKAGE_MANIFEST_SHA, PACKAGE_MANIFEST_BYTES)])
    authority=context["authority"]
    trees={key:exact_tree(Path(authority[key]["root"])) for key in ("v508_authority_registration_tree","v508_materialization_evidence_tree","v508_phase_a_attempt_tree","v508_qualification_tree")}
    return {"records":records,"records_sha256":csha(records),"ancestry_trees":trees,"wam_pipeline_package_tree":authority["wam_pipeline_package_tree"]}
...
def derive_driver_command(context: dict) -> list[str]:
    ...
    return [str(RLPY), closure["fresh_phase_a_driver"]["path"],
            ...
            "--package-manifest", closure["wam_pipeline_package_tree_manifest"]["path"], "--package-manifest-sha", closure["wam_pipeline_package_tree_manifest"]["sha256"], "--package-manifest-bytes", str(closure["wam_pipeline_package_tree_manifest"]["logical_bytes"])]
...
def execute(args: argparse.Namespace, hooks=None) -> int:
    ...
    terminal = {"format": TERMINAL_FORMAT, "status": "passed_exact_one_nested_phase_a_driver" if success else "failed_no_retry",
                ...
                "runtime_observation": {"execution_authority_materialized": True, "phase_a_launcher_executed": True,
                    "phase_a_driver_executed": state["started"], "worker_pythonpath_injected": state["started"], "qualification_output_created": QUALIFICATION_ROOT.is_dir(),
...
def synthetic_self_test() -> int:
    ...
    checks["source_order"] = len(SOURCE_ORDER) == 22 and len(set(SOURCE_ORDER)) == 22
    checks["driver_uses_frozen_launcher"] = "--launcher-source" in derive_driver_command({"closure": {
        ...
        "wam_pipeline_package_tree_manifest": {"path": "manifest", "sha256": "2"*64, "logical_bytes": 1},
    ...
    checks["v508_failure_anchor"] = all(token in source for token in (FAILURE_FORENSIC_SHA, "No module named 'wam_pipeline'", "failed_no_retry"))
    checks["wam_pipeline_manifest"] = all(token in source for token in (PACKAGE_MANIFEST_SHA, "wam_pipeline_package_tree", "wam_pipeline_exact_worker_environment"))
    checks["v509_exact7"] = "7912671a0ac69fbc15ff6bfc547d0e3810256e83cda76d7ef8f002c6cc846c75" in source
    ...
    checks["materializer_binding"] = AUTHORITY_MATERIALIZER_SHA in source and AUTHORITY_MATERIALIZER_BYTES == 28224
