...
from wam_pipeline.v420_action_phase_progressive_runtime import (
...
def main() -> int:
    ...
    if payload.get("format") != "strict-track2-v420-action-phase-progressive-preregistration-v1":
        raise RuntimeError("wrong v420 preregistration")
    ...
    sys.argv = argv
    base.Track2V385NativeBatchCleanReanchor = Track2V420ActionPhaseProgressive
    try:
        code = base.main()
    finally:
        Path(temporary).unlink(missing_ok=True)
    report = json.loads(output.read_text())
    report["format"] = "strict-track2-v420-recursive-reward-causal-gate-v1"
