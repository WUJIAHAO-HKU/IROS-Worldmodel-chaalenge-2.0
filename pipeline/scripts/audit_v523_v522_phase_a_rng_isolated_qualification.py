#!/usr/bin/env python3
"""Independent v523 auditor enforcing exact21 per-call RNG evidence."""
...
def final_source_closure(worker_receipt):
    ...
    exact_roles=formal["phase_a_output_and_receipt_schema"]["source_closure_contract"]["exact_roles"];records=[]
    if exact_roles!=EXACT_ROLES or set(formal.get("execution_sources",{}))!=set(exact_roles):raise RuntimeError("final exact eight roles")
