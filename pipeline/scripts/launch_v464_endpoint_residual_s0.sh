#!/usr/bin/env bash
# Preregistered public-train v464 WM parent gate only. No reward, policy update, RL, dev/final, or submission.
set -euo pipefail
ROOT='/root/autodl-tmp/IROS_WAM_2.0 challenge'
J="$ROOT/artifacts/strict_track2_joint_augmentation_20260810"
V461="$J/v461_endpoint200_seed1612_20260823"
REG="$J/v464_endpoint_residual_seed1615_20260823"
TRAINING="$REG/training"
RELEASE="$J/v464_v169_endpoint_residual_parent_release"
RLPY='/root/autodl-tmp/conda_envs/rlinf_track2/bin/python'
PREP="$ROOT/pipeline/scripts/prepare_v464_endpoint_residual_5fold.py"
TRAINER="$ROOT/pipeline/scripts/train_v464_endpoint_residual_5fold.py"
PACKAGER="$ROOT/pipeline/scripts/package_v464_endpoint_residual_release.py"
RUNTIME="$ROOT/pipeline/wam_pipeline/v464_v169_endpoint_residual_runtime.py"
...
LOCK_FILE='/var/lock/v464_endpoint_residual_seed1615.lock'
...
test "$(sha256sum "$PREP" | awk '{print $1}')" = '7b726ae795586c783c2562b3ca5d9d8e03b407902442982a6b7672f112b93ed6'
test "$(sha256sum "$TRAINER" | awk '{print $1}')" = '4f03a285b324515880302548a7a3597a2bf7ef8748d3f6251a1f88c638458a9a'
test "$(sha256sum "$PACKAGER" | awk '{print $1}')" = 'f2303a12438419fbce9b8642626993d0d8c999625b633c7c0ece40361412ce9b'
test "$(sha256sum "$RUNTIME" | awk '{print $1}')" = '03dca58a0539e35085805af8b3bc193c3a6d1cbd572d43544e7822a1832b3515'
...
payload={'format':'strict-track2-v464-launcher-failure-receipt-v1','passed':False,'reason':reason,'exit_code':int(code),'wall_seconds':int(elapsed),'gpu_peak_mib':int(peak),'training_process_group':int(pid) if pid else None,'reward_loaded':False,'policy_updates':0,'rl_authorized':False}
tmp=path+'.tmp'
...
WATCHDOG_PID=''
trap - EXIT TERM INT
echo V464_ENDPOINT_RESIDUAL_S0_AND_ALL200_COMPLETE
