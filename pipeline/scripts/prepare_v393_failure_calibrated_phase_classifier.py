...
NAME = "v393_public_failure_calibrated_phase_seed1554_20260823"
RUN = J / NAME
...
def main() -> None:
    ...
    sources = {
        "trainer": ROOT / "pipeline/scripts/train_v393_failure_calibrated_phase_classifier.py",
    ...
    payload = {
        "format": "strict-track2-v393-failure-calibrated-phase-preregistration-v1",
        ...
        "fixed_selection": {
            ...
            "onpolicy_failure_train_route_negative_specificity_min": 0.99,
            "onpolicy_failure_train_route_rows_min": 32,
        ...
        "post_selection_gate": {
            "independent_failure_route_rows_min": 8,
            "independent_failure_route_negative_specificity_min": 0.99,
            "all_required": True,
        },
