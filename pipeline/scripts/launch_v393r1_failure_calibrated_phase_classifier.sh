...
RUN="$J/v393r1_public_failure_calibrated_phase_seed1554_20260823"
...
taskset -c 0-15 "$PY" "$ROOT/pipeline/scripts/train_v393r1_failure_calibrated_phase_classifier.py" \
