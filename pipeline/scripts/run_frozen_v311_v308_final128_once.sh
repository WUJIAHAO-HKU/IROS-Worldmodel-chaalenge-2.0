...
FROZEN="$OFF/frozen_candidates/v311_v308_v301_rtx5090_step10_seed1471"
...
OUTPUT_ROOT="$EVAL/frozen_v311_v308_v301_rtx5090_step10_seed1471_final128"
...
WRAPPER="$P/run_frozen_v311_v308_final128_once.sh"
CPUSET='0-21'
...
print('V311_FROZEN_FINAL128_INPUTS_VERIFIED')
PY
