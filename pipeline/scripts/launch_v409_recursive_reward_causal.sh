...
RUN="$J/v409_half_contracted_progressive_seed1567_20260823"
REG="$O/run_registry/v409_half_contracted_progressive_seed1567_20260823"
...
set +e
taskset -c 0-11 "$PY" "$ROOT/pipeline/scripts/audit_v409_recursive_reward_causal.py" \
...
echo "V409_RECURSIVE_AUDIT_EXIT=$status"
exit "$status"
