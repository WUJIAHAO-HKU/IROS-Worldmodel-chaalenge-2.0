#!/usr/bin/env python3
"""Atomically register the v494 interpreter-symlink repair authority; run no execution source."""
...
CONTRACT_PATH = ROOT / "pipeline/scripts/v494_v493_v490_interpreter_symlink_repair_execution_authority_contract.json"
CONTRACT_FORMAT = "strict-track2-v494-v493-v490-interpreter-symlink-repair-execution-authority-design-contract-v1"
CONTRACT_STATUS = "design_only_frozen_sources_pending_independent_review_no_authority"
OUTPUT_FORMAT = "strict-track2-v494-v493-v490-interpreter-symlink-repair-execution-authority-v1"
OUTPUT_STATUS = "authorized_exact_one_external_v494_interpreter_symlink_repaired_outer_attempt"
...
INNER_ATTEMPT_ROOT = J / "v494_v493_v490_interpreter_symlink_repaired_reconciliation_inner_attempt_seed1636_20260825"
...
SOURCE_ROLES = {
    ...
    "v493_inner_wrapper", "corrected_inner_wrapper", "reconciler_r2",
...
def synthetic_self_test() -> int:
    checks = {
        ...
        "check_count": len(AUTH_CHECK_KEYS) == 28,
        ...
        "fresh_roots": all("v494_" in path.name for path in
...
def main() -> int:
    ...
    if (set(contract) != CONTRACT_TOP_KEYS or contract.get("format") != CONTRACT_FORMAT
            or contract.get("status") != CONTRACT_STATUS or contract.get("seed") != 1636
            or pending(contract)):
