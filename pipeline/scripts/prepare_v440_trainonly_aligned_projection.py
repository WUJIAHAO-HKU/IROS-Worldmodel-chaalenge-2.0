#!/usr/bin/env python3
"""Prospectively freeze v440 train-only calibration and S0/S1 gates."""
...
def main() -> int:
    ...
    files = {
        "calibrator": ROOT / "pipeline/scripts/calibrate_v440_trainonly_rgb_projection.py",
        "runtime": ROOT / "pipeline/wam_pipeline/v440_v169_trainonly_aligned_projection_runtime.py",
        "s0_auditor": ROOT / "pipeline/scripts/audit_v440_static_contract.py",
        "packager": ROOT / "pipeline/scripts/package_v440_trainonly_aligned_release.py",
        "split": args.split,
    ...
    payload = {
        "format": "strict-track2-v440-trainonly-alignment-preregistration-v1",
