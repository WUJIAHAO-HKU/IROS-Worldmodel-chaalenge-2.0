...
WRAPPER_PATH=ROOT/"pipeline/scripts/launch_v500_v499_v498_v497_v496_v495_failure_tree_diagnostic_reconciliation_inner.py"
AUTHORITY_CONTRACT_PATH=ROOT/"pipeline/scripts/v500_v499_v498_v497_v496_v495_failure_tree_diagnostic_execution_authority_contract.json"
AUTHORITY_MATERIALIZER_PATH=ROOT/"pipeline/scripts/materialize_v500_v499_v498_v497_v496_v495_failure_tree_diagnostic_execution_authority.py"
AUTHORITY_MATERIALIZER_SHA="e717c1360e5691865dd299249630b3b4cef1965c68e8a457008b50415fe9afb5"
AUTHORITY_MATERIALIZER_BYTES=109256
...
OUTER_WRAPPER_PATH=ROOT/"pipeline/scripts/launch_v500_v499_v498_v497_v496_v495_failure_tree_diagnostic_reconciliation_outer.py"
OUTER_EVIDENCE_ROOT=J/"v500_v499_v498_v497_v496_v495_failure_tree_diagnostic_reconciliation_outer_execution_evidence_seed1642_20260825"
...
R2_BYTES=51845
ATTEMPT_ROOT=J/"v500_v499_v498_v497_v496_v495_failure_tree_diagnostic_reconciliation_inner_attempt_seed1642_20260825"
ATTEMPT_PREP=ATTEMPT_ROOT.with_name(ATTEMPT_ROOT.name+".attempt-prep")
LOCK_PATH=J/".v500_v499_v498_v497_v496_v495_failure_tree_diagnostic_reconciliation_attempt.lock"
...
AUTHORITY_FORMAT="strict-track2-v500-v499-v498-v497-v496-v495-failure-tree-diagnostic-execution-authority-v1"
AUTHORITY_STATUS="authorized_exact_one_external_v500_failure_tree_diagnostic_outer_attempt"
AUTHORITY_CONTRACT_FORMAT="strict-track2-v500-v499-v498-v497-v496-v495-failure-tree-diagnostic-execution-authority-design-contract-v1"
...
INTENT_FORMAT="strict-track2-v500-v499-v498-v497-v496-v495-failure-tree-diagnostic-reconciliation-inner-attempt-intent-v1"
TERMINAL_FORMAT="strict-track2-v500-v499-v498-v497-v496-v495-failure-tree-diagnostic-reconciliation-inner-attempt-terminal-v1"
...
def preflight(args)->dict:
 ...
 if set(contract)!=AUTHORITY_CONTRACT_TOP_KEYS or contract.get("format")!=AUTHORITY_CONTRACT_FORMAT or contract.get("status")!=AUTHORITY_CONTRACT_STATUS or contract.get("seed")!=1642 or contract.get("execution_boundary")!=EXECUTION_BOUNDARY or contains_pending(contract):raise RuntimeError("authority contract schema")
 ...
 if outer_intent.get("format")!="strict-track2-v500-v499-v498-v497-v496-v495-failure-tree-diagnostic-reconciliation-outer-attempt-intent-v1" or outer_intent.get("status")!="committed_before_corrected_inner_start" or outer_intent.get("command_argv")!=expected_nested_argv or outer_intent.get("command_argv_sha256")!=csha(expected_nested_argv) or outer_intent.get("authority_receipt")!=authority_record:raise RuntimeError("outer intent crossbind")
...
def synthetic_self_test()->int:
 checks={
  ...
  "authority_top89_check81":len(AUTHORITY_TOP_KEYS)==89 and len(AUTHORITY_CHECK_KEYS)==81 and len(CONTRACT_TOP_KEYS)==54 and len(SOURCE_ROLE_ORDER)==31,
