#!/usr/bin/env python3
"""Materialize the fresh v524 authority after the frozen v523 pre-worker failure."""
...
SELF_PATH = S / 'materialize_v524_v523_phase_a_exact_source_roles_repair_execution_authority.py'
CONTRACT_PATH = S / 'v524_v523_phase_a_exact_source_roles_repair_execution_authority_contract.json'
LAUNCHER_PATH = S / 'launch_v524_v523_phase_a_cache_qualification.py'
DRIVER_PATH = S / 'generate_v524_v523_phase_a_cache_qualification.py'
WORKER_PATH = S / 'generate_v524_v523_phase_a_cache_qualification_worker.py'
PROXY_PATH = S / 'v520_v519_rng_isolated_v169_runtime_proxy.py'
AUDITOR_PATH = S / 'audit_v524_v523_phase_a_rng_isolated_qualification.py'
PREREG_ROOT = J / 'v524_v523_phase_a_cache_qualification_prereg_seed1660_20260826'
...
OLD_CONTRACT = S / 'v523_v522_phase_a_per_call_rng_contract_repair_execution_authority_contract.json'
OLD_CONTRACT_SHA = 'e26f20b1a191f7e2711725786498bfaa0d88697d085410f4894eb3c5b2df2a8f'
OLD_CONTRACT_BYTES = 39453
OLD_MATERIALIZER = S / 'materialize_v523_v522_phase_a_per_call_rng_contract_repair_execution_authority.py'
OLD_MATERIALIZER_SHA = '2b131db2f0fb95e24abc646930bcf88cae791ec5b9d696f287e55daf00f7c88a'
OLD_MATERIALIZER_BYTES = 33316
OLD_AUTHORITY_ROOT = J / 'v523_v522_phase_a_per_call_rng_contract_repair_execution_authority_seed1659_20260826'
OLD_AUTHORITY_RECEIPT = OLD_AUTHORITY_ROOT / 'authority_receipt.json'
OLD_AUTHORITY_RECEIPT_SHA = 'e0cf422beeaf44b89eff8d359449dc733931f254491abc404fc6a6285bee5146'
OLD_AUTHORITY_RECEIPT_BYTES = 65145
OLD_AUTHORITY_TREE = {
    ...
    'sha256sum_lines_digest_sha256': 'fcf06088efdd70191851dbd6a3ffe3d51adfed16ff4978b179c74a502c24e06d',
    'canonical_json_triples_digest_sha256': '22e25eafaa9f0ba4963b5b1592895815acee046f165d93f8d2cf1f4f3af3dd6a',
}
OLD_LAUNCHER = S / 'launch_v523_v522_phase_a_cache_qualification.py'
OLD_LAUNCHER_SHA = 'd207f80925b68830cbbf5a5e369b34b721a3831682f9d792cf3ed87d41eed7d3'
OLD_LAUNCHER_BYTES = 81577
OLD_DRIVER = S / 'generate_v523_v522_phase_a_cache_qualification.py'
OLD_DRIVER_SHA = 'ee7a2a327cc7fc8f282eef9b97701860c310901cdf383d8bc923b7f276c4f3ab'
OLD_DRIVER_BYTES = 47276
OLD_WORKER = S / 'generate_v523_v522_phase_a_cache_qualification_worker.py'
OLD_WORKER_SHA = '89a552416c054fa2590d7f15b5fb829b8eb2cf8a02479e2115b825bf6e49d627'
OLD_WORKER_BYTES = 38990
OLD_AUDITOR = S / 'audit_v523_v522_phase_a_rng_isolated_qualification.py'
OLD_AUDITOR_SHA = 'f09a17f068f9f6f471be7bba10162cab406d18957d48586eed083e25d6f59ea2'
OLD_AUDITOR_BYTES = 47453
OLD_ATTEMPT_ROOT = J / 'v523_v522_phase_a_cache_qualification_attempt_seed1659_20260826'
OLD_QUALIFICATION_ROOT = Path('/root/v523_v522_phase_a_cache_qualification_seed1659_20260826')
...
OLD_ATTEMPT_TREE = {
    ...
    'inventory': [
        ['intent.json', 'cbd460967ee5f5b4aaf7c9787f4f264b292f208db502b6b43e0302a5bc5ca3e0', 5597],
        ['phase_a_stderr.log', '7885f62cee9a2ecff6bf08299cf93cdfb6ddec9e0fe8810337af4da80bc4e866', 947],
        ['phase_a_stdout.log', hashlib.sha256(b'').hexdigest(), 0],
        ['terminal_receipt.json', '1365c0c9f7e7adb8034c92c6d226a4cde9164178b8a8a85e5d929d4c3c7588a2', 38156],
    ],
    'file_count': 4, 'logical_file_bytes': 44700,
    'sha256sum_lines_digest_sha256': '8a8fe960f79b3f026b187488babe3dc3886658520e9081a524179e728a938f5a',
    'canonical_json_triples_digest_sha256': 'c67c41bdef17f340dfd3f9b6cb18a642eeadaeb0e4d97e21ab539aa2b9c90419',
}
FAILURE_FORENSIC = S / 'v524_v523_phase_a_exact_source_roles_failure_forensic.json'
...
ANCESTRY_ROLES = [
    'v524_v523_phase_a_failure_forensic', 'v523_authority_design_contract',
    'v523_authority_materializer', 'v523_authority_receipt', 'v523_phase_a_launcher',
    'v523_phase_a_driver', 'v523_phase_a_worker', 'v523_phase_a_independent_auditor',
    'v523_attempt_intent', 'v523_attempt_stdout', 'v523_attempt_stderr', 'v523_attempt_terminal',
]
...
OUTPUT_FORMAT = 'strict-track2-v524-v523-phase-a-exact-source-roles-repair-execution-authority-v1'
OUTPUT_STATUS = 'authorized_exact_one_external_v524_phase_a_cache_qualification_attempt'
...
CHECK_KEYS = sorted({
    ...
    'v523_attempt_exact4', 'v523_terminal_failed_no_retry', 'v523_partition_exact',
    'v523_root_cause_exact_ordered8', 'v523_forensic_exact', 'v523_cleanup_closed',
    'v523_services_restored', 'v523_qualification_absent', 'fresh_roots_absent',
...
CONTRACT_TOP_KEYS = {
    ...
    'v523_authority_registration_tree', 'v523_authority_receipt',
    'v523_authority_semantics', 'v523_attempt_tree', 'v523_attempt_intent',
    'v523_attempt_stdout', 'v523_attempt_stderr', 'v523_attempt_terminal',
    'v523_phase_a_failure_forensic', 'v523_phase_a_execution_partition',
    'v523_exact_source_roles_failure_root_cause', 'historical_absences',
...
def load_base():
    ...
    spec = importlib.util.spec_from_file_location('v523_frozen', OLD_MATERIALIZER)
...
def validate_old_state():
    records = {
        'v524_v523_phase_a_failure_forensic': regular(FAILURE_FORENSIC, FAILURE_FORENSIC_SHA, FAILURE_FORENSIC_BYTES),
        'v523_authority_design_contract': regular(OLD_CONTRACT, OLD_CONTRACT_SHA, OLD_CONTRACT_BYTES),
        'v523_authority_materializer': regular(OLD_MATERIALIZER, OLD_MATERIALIZER_SHA, OLD_MATERIALIZER_BYTES),
        'v523_authority_receipt': regular(OLD_AUTHORITY_RECEIPT, OLD_AUTHORITY_RECEIPT_SHA, OLD_AUTHORITY_RECEIPT_BYTES),
        'v523_phase_a_launcher': regular(OLD_LAUNCHER, OLD_LAUNCHER_SHA, OLD_LAUNCHER_BYTES),
        'v523_phase_a_driver': regular(OLD_DRIVER, OLD_DRIVER_SHA, OLD_DRIVER_BYTES),
        'v523_phase_a_worker': regular(OLD_WORKER, OLD_WORKER_SHA, OLD_WORKER_BYTES),
        'v523_phase_a_independent_auditor': regular(OLD_AUDITOR, OLD_AUDITOR_SHA, OLD_AUDITOR_BYTES),
        'v523_attempt_intent': regular(OLD_INTENT, 'cbd460967ee5f5b4aaf7c9787f4f264b292f208db502b6b43e0302a5bc5ca3e0', 5597),
        'v523_attempt_stdout': regular(OLD_STDOUT, hashlib.sha256(b'').hexdigest(), 0),
        'v523_attempt_stderr': regular(OLD_STDERR, '7885f62cee9a2ecff6bf08299cf93cdfb6ddec9e0fe8810337af4da80bc4e866', 947),
        'v523_attempt_terminal': regular(OLD_TERMINAL, '1365c0c9f7e7adb8034c92c6d226a4cde9164178b8a8a85e5d929d4c3c7588a2', 38156),
    }
    ...
    if (authority_tree != OLD_AUTHORITY_TREE or len(authority) != 71 or authority.get('passed') is not True
            ...
            or len(authority.get('source_closure', {})) != 27
    ...
    legacy_roles = [
        'phase_a_materializer', 'phase_a_driver', 'phase_a_process_worker',
        'phase_a_cache_scope_helper', 'phase_a_independent_auditor',
        'phase_a_static_auditor', 'phase_a_launcher',
    ]
    expected_root_cause = {
        'error': 'exact seven source roles',
        'failure_stage': 'driver_pre_worker_actual_source_closure',
        'formal_exact_roles_count': 7, 'driver_expected_roles_count': 8,
        'shared_role_count': 4, 'formal_legacy_exact_roles': legacy_roles,
        'driver_expected_exact_roles': expected_roles,
        'shared_roles': ['phase_a_driver', 'phase_a_process_worker',
                         'phase_a_independent_auditor', 'phase_a_static_auditor'],
        'driver_only_roles': ['phase_a_preregistration_materializer',
                              'phase_a_rng_isolation_proxy', 'cache_scope_helper',
                              'frozen_phase_a_launcher'],
        'formal_only_legacy_roles': ['phase_a_materializer',
                                     'phase_a_cache_scope_helper', 'phase_a_launcher'],
        'sole_difference_class': 'formal_legacy7_vs_existing_execution_sources_ordered8',
        'semantic_repair_exact': {
            'formal_exact_roles_source': 'execution_source_records_roles_in_existing_order',
            'formal_exact_roles_count': 8, 'source_record_contents_unchanged': True,
            'execution_sources_digest_semantics_unchanged': True,
            'worker_semantics_unchanged': True, 'rng_proxy_semantics_unchanged': True,
            'per_call_rng_contract_semantics_unchanged': True,
        },
    }
    if (attempt_tree != OLD_ATTEMPT_TREE or terminal.get('status') != 'failed_no_retry'
            ...
            or forensic.get('v523_attempt_tree') != attempt_tree
            or forensic.get('execution_partition') != expected_partition
            or forensic.get('root_cause') != expected_root_cause
            or forensic.get('independent_audit') != {'check_count': 15, 'all_checks_true': True, 'checks_sha256': '8f05330bea32d0e624181f29ca5e60d5f49efb7493447a7162080d286197da85'}
        ...
        raise RuntimeError('v523 failure')
    if service_health() != terminal['v218_health_after'] or terminal['v218_health_before'] != terminal['v218_health_after']:
        raise RuntimeError('v523 service restoration')
    if phase_pids(): raise RuntimeError('phase pids')
    partition = expected_partition
    semantics = {'passed': True, 'top_key_count': 71, 'check_count': 33, 'source_closure_count': 27,
                 'source_closure_all_current': True, 'input_snapshots_exactly_equal': True,
                 'launcher_invocations_consumed_by_v523_attempt': 1,
                 'nested_driver_invocations_consumed_by_v523_attempt': 1,
                 'historical_downstream_absence_revalidated_after_attempt': False}
    return {'records': records, 'authority_tree': authority_tree,
            'authority_receipt': records['v523_authority_receipt'], 'authority_semantics': semantics,
            'attempt_tree': attempt_tree, 'attempt_intent': records['v523_attempt_intent'],
            'attempt_stdout': records['v523_attempt_stdout'], 'attempt_stderr': records['v523_attempt_stderr'],
            'attempt_terminal': records['v523_attempt_terminal'], 'failure_forensic': forensic,
...
def validate_prereg(source_records):
    ...
    rows = value.get('execution_source_records', [])
    ...
    row_map = {row['role']: {key: item for key, item in row.items() if key != 'role'} for row in rows}
    formal_roles = value.get('phase_a_output_and_receipt_schema', {}).get(
        'source_closure_contract', {}).get('exact_roles')
    if (roles != expected_roles or formal_roles != expected_roles
            or value.get('qualification_output_root') != str(QUALIFICATION_ROOT)
            or value.get('execution_sources_digest_sha256') != csha(rows)
            or value.get('execution_sources') != row_map
...
def main():
    ...
    if set(contract) != CONTRACT_TOP_KEYS or contract.get('format') != CONTRACT_FORMAT or contract.get('status') != CONTRACT_STATUS or type(contract.get('seed')) is not int or contract.get('seed') != 1660:
    ...
    expected_paths = {'authority_materializer': SELF_PATH, 'fresh_phase_a_launcher': LAUNCHER_PATH,
                      ...
                      'v524_v523_phase_a_failure_forensic': FAILURE_FORENSIC,
                      'v523_authority_design_contract': OLD_CONTRACT, 'v523_authority_materializer': OLD_MATERIALIZER,
                      'v523_authority_receipt': OLD_AUTHORITY_RECEIPT, 'v523_phase_a_launcher': OLD_LAUNCHER,
                      'v523_phase_a_driver': OLD_DRIVER, 'v523_phase_a_worker': OLD_WORKER,
                      'v523_phase_a_independent_auditor': OLD_AUDITOR, 'v523_attempt_intent': OLD_INTENT,
                      'v523_attempt_stdout': OLD_STDOUT, 'v523_attempt_stderr': OLD_STDERR,
                      'v523_attempt_terminal': OLD_TERMINAL}
    ...
    expected_lineage = {'name': 'v524_v523_phase_a_exact_source_roles_repair',
    ...
    exact_values = {'authority_materializer_source': materializer_record,
                    ...
                    'v523_attempt_tree': old['attempt_tree'], 'v523_attempt_intent': old['attempt_intent'],
                    'v523_attempt_stdout': old['attempt_stdout'], 'v523_attempt_stderr': old['attempt_stderr'],
    ...
    trees = {'v523_authority_current': str(OLD_AUTHORITY_ROOT), 'v523_attempt_current': str(OLD_ATTEMPT_ROOT)}
