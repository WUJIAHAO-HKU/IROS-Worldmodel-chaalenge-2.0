...
RUN="$J/v420_action_phase_progressive_seed1573_20260823"
REG="$O/run_registry/v420_action_phase_progressive_seed1573_20260823"
...
set +e
taskset -c 0-11 "$PY" "$ROOT/pipeline/scripts/audit_v420_recursive_reward_causal.py" \
...
echo "V420_RECURSIVE_AUDIT_EXIT=$status"
exit "$status"
