#!/usr/bin/env python3
"""Numeric, speed, causality, and left-nonregression contract for v322."""
...
def main() -> int:
    ...
    serial_runtime = Track2V322CausalAlphaTerminal(
        args.checkpoint_dir, args.library_index, args.device, args.action_gate
    )
    batch_runtime = Track2V322CausalAlphaTerminal(
        args.checkpoint_dir, args.library_index, args.device, args.action_gate
    )
    ...
    causal_alpha = batch_runtime._causal_alpha(probability)
    ...
    checks = {
        ...
        "valid_transition_causal_alpha_positive": causal_alpha > 0.0,
    ...
    report = {
        "format": "strict-track2-v322-causal-alpha-terminal-contract-v1",
