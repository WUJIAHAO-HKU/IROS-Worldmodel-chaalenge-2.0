...
PREREG="$ROOT/pipeline/config/strict_track2_http_cpu_observation_transport_preregistration.json"
RUN_ROOT="$AUDIT_ROOT/runs/full_budget_resource_smoke_v157_cpu_transport_seed1238"
...
assert registration["invariants"]["official_pi05_changed"] is False
assert registration["invariants"]["official_reward_changed"] is False
assert registration["invariants"]["official_rl_algorithm_changed"] is False
assert registration["invariants"]["official_rl_budget_changed"] is False
PY
