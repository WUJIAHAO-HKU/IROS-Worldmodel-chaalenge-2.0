...
NAME = "v384_action_phase_clean_reanchor_seed1547_20260823"
RUN = J / NAME
...
def main() -> None:
    ...
    runtime = ROOT / "pipeline/wam_pipeline/v384_action_phase_clean_reanchor_runtime.py"
    ...
    manifest = {
        ...
        "model_version": "track2-v384-v326-sourcegate-actionphase-clean-reanchor",
        ...
        "route": "generated source and right post-grasp and action probability >=0.99 and no failure signature and action-only terminal phase",
        "reward_or_outcomes_used": False,
        "hidden_or_final_data": False,
    }
    (release / "action_phase_clean_reanchor_manifest.json").write_text(json.dumps(manifest, indent=2) + "\n")
    prereg = {
        "format": "strict-track2-v384-action-phase-clean-reanchor-preregistration-v1",
        ...
        "fixed_candidate": {
            ...
            "selection": "action-only phase row and future endpoint; no context visual in terminal choice",
        ...
        "fixed_recursive_gate": {
            ...
            "ground_truth_negative_false_positive_rate_at_0p9_max_both": 0.10,
            "all_required": True,
        },
        "evidence_sha256": {
