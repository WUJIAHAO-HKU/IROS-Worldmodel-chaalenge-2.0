...
FORMAL_BYTES = 21296
AUTHORITY_ROOT = J / "v487_v486_phase_a_static_reconciliation_authority_seed1629_20260824"
AUTHORITY_PATH = AUTHORITY_ROOT / "authority_receipt.json"
AUTHORITY_DESIGN_PATH = ROOT / "pipeline/scripts/v487_v486_phase_a_static_reconciliation_postregistration_authority_contract.json"
AUTHORITY_DESIGN_FORMAT = "strict-track2-v487-v486-phase-a-static-reconciliation-postregistration-authority-design-contract-v1"
AUTHORITY_DESIGN_STATUS = "design_only_frozen_sources_awaiting_independent_review_no_authority"
AUTHORITY_MATERIALIZER_PATH = ROOT / "pipeline/scripts/materialize_v487_v486_phase_a_static_reconciliation_postregistration_authority.py"
AUTHORITY_MATERIALIZER_SHA = "6c7b5e259e388d59bfb71a09c068472037dbde74468f5d9ba1b96fa92a8abd3d"
AUTHORITY_MATERIALIZER_BYTES = 18312
ATTEMPT_ROOT = J / "v487_v486_phase_a_static_reconciliation_attempt_seed1629_20260824"
...
SUPERSEDED_AUTHORITY_ROOT = J / "v486_v485_phase_a_static_reconciliation_authority_seed1628_20260824"
SUPERSEDED_AUTHORITY_PREP = SUPERSEDED_AUTHORITY_ROOT.with_name(SUPERSEDED_AUTHORITY_ROOT.name + ".registration-prep")
SUPERSEDED_ATTEMPT_ROOT = J / "v486_v485_phase_a_static_reconciliation_attempt_seed1628_20260824"
FAILED_AUTHORITY_EVIDENCE_ROOT = ROOT / "pipeline/scripts/v486_v485_phase_a_static_reconciliation_authority_materialization_evidence_20260824"
DEPLOYED_TRANSCRIPT = ROOT / "pipeline/scripts/v486_materializer_failed_invocation_console_capture_reconstructed.txt"
DEPLOYED_TRANSCRIPT_SHA = "764f10d36f1cb74be2535f4c442b4eb12f2bc9203e8c285aaf3e3253f6c4b8f9"
DEPLOYED_TRANSCRIPT_BYTES = 514
AUTH_FORMAT = "strict-track2-v487-v486-phase-a-static-reconciliation-postregistration-authority-v1"
AUTH_STATUS = "authorized_exact_one_fresh_readonly_static_reconciliation_attempt"
INTENT_FORMAT = "strict-track2-v487-v486-v485-static-reconciliation-attempt-intent-v1"
TERMINAL_FORMAT = "strict-track2-v487-v486-v485-static-reconciliation-attempt-terminal-v1"
AUTHORIZATION = {
...
AUTHORITY_CHECK_KEYS = (
    "deployed_transcript_exact",
    "exact7_current",
    "f813_REG_exact2",
    "formal_exact_nonauthorizing_phase_a",
    "fresh_authority_state_absent",
    "input_pre_post_snapshots_equal",
    "no_live_reconciliation",
    "old_authority_materialization_attempt_consumed_no_retry",
    "old_authority_root_permanently_unused",
    "old_b73_REG_exact2",
    "required_outputs_absent",
    "superseded_failure_evidence_exact4",
    "superseded_missing_transcript_root_cause_exact",
    "superseded_process_receipt_exact",
    "unsafe_authorities_all_false",
    "v487_sources_exact",
)
AUTHORITY_CHECK_KEYSET_SHA = "c8c137725601f6670aed90d8ae383314519a3dc37afec5876670ae319912594b"
AUTHORITY_CHECKS_SHA = "1f8e8ef0d299cdf1514a53f4bef58a8421565a2b2cee4d63677ebb4b32ade837"
SYNTHETIC_EVIDENCE = {
    "passed": True,
    "check_count": 4,
    "checks": {
...
FAILED_AUTHORITY_EVIDENCE_TREE = {
    "inventory": [
        ["materializer_argv.json", "64856764178684495674e5e5ed9e4865ad43511b91f3843231547181c1f34ef1", 8478],
        ["materializer_process_receipt.json", "cd585d62c22451613f1ed9a521d45e04c709141f04ca1ba46fad8e193cc503ee", 1085],
        ["materializer_stderr.log", "1b1506989e4c0d64e2062eaedab180763bd9adbde069f4a2c6bd70a95806ba4d", 1062],
        ["materializer_stdout.log", "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855", 0],
    ],
    "file_count": 4,
    "logical_file_bytes": 10625,
    "sha256sum_lines_digest_sha256": "17207dc7a1971b3cde3cec81661f0a93a609081ebd92468b4ffda91067e90724",
    "canonical_json_triples_digest_sha256": "470e243325e893498810219ed4c7cc4892e7e17c38c8e25c8e5695ba4164b686",
}
...
def preflight(args) -> dict:
    ...
    exact_paths = {
        ...
        "superseded_authority_design_contract": (
            ROOT / "pipeline/scripts/v486_v485_phase_a_static_reconciliation_postregistration_authority_contract.json",
            ROOT / "pipeline/scripts/v486_v485_phase_a_static_reconciliation_postregistration_authority_contract.json",
            "9a17c34a64efc0a608e464e78bbb50cb5c6a9e33264e67e0e366ae35fadba868",
            14467,
        ),
        "superseded_authority_materializer": (
            ROOT / "pipeline/scripts/materialize_v486_v485_phase_a_static_reconciliation_postregistration_authority.py",
            ROOT / "pipeline/scripts/materialize_v486_v485_phase_a_static_reconciliation_postregistration_authority.py",
            "33079cd1827214c851b771f303dd5b575a12699116de7f927a18c5ea25ba7220",
            20222,
        ),
        "superseded_execution_wrapper": (
            ROOT / "pipeline/scripts/launch_v486_v485_static_false_positive_reconciliation.py",
            ROOT / "pipeline/scripts/launch_v486_v485_static_false_positive_reconciliation.py",
            "55922854a36a550384ce23313283d2c970b0873bc43e7675b63e4a04c393f897",
            56767,
        ),
        "failed_authority_process_receipt": (
            FAILED_AUTHORITY_EVIDENCE_ROOT / "materializer_process_receipt.json",
            FAILED_AUTHORITY_EVIDENCE_ROOT / "materializer_process_receipt.json",
            "cd585d62c22451613f1ed9a521d45e04c709141f04ca1ba46fad8e193cc503ee",
            1085,
        ),
        "failed_authority_stderr": (
            FAILED_AUTHORITY_EVIDENCE_ROOT / "materializer_stderr.log",
            FAILED_AUTHORITY_EVIDENCE_ROOT / "materializer_stderr.log",
            "1b1506989e4c0d64e2062eaedab180763bd9adbde069f4a2c6bd70a95806ba4d",
            1062,
        ),
        "failed_authority_stdout": (
            FAILED_AUTHORITY_EVIDENCE_ROOT / "materializer_stdout.log",
            FAILED_AUTHORITY_EVIDENCE_ROOT / "materializer_stdout.log",
            "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
            0,
        ),
        "failed_authority_argv": (
            FAILED_AUTHORITY_EVIDENCE_ROOT / "materializer_argv.json",
            FAILED_AUTHORITY_EVIDENCE_ROOT / "materializer_argv.json",
            "64856764178684495674e5e5ed9e4865ad43511b91f3843231547181c1f34ef1",
            8478,
        ),
        "deployed_transcript": (DEPLOYED_TRANSCRIPT, DEPLOYED_TRANSCRIPT, DEPLOYED_TRANSCRIPT_SHA, DEPLOYED_TRANSCRIPT_BYTES),
    }
    records = {}
    ...
    record_from_payload(authority.get("future_execution_wrapper_source"), records["wrapper"], "authority wrapper")
    ...
    failure_tree = exact_tree(FAILED_AUTHORITY_EVIDENCE_ROOT)
    if failure_tree != FAILED_AUTHORITY_EVIDENCE_TREE:
        raise RuntimeError("superseded authority evidence exact4")
    failure_receipt = json.loads((FAILED_AUTHORITY_EVIDENCE_ROOT / "materializer_process_receipt.json").read_text())
    if (
        set(failure_receipt) != {"format", "returncode", "wall_seconds", "argv_evidence", "stdout", "stderr", "materializer_invocations"}
        or failure_receipt.get("format") != "strict-track2-v486-authority-materializer-process-receipt-v1"
        or failure_receipt.get("returncode") != 1
        or failure_receipt.get("wall_seconds") != 0.11483402
        or failure_receipt.get("materializer_invocations") != 1
        or failure_receipt.get("argv_evidence") != records["failed_authority_argv"]
        or failure_receipt.get("stdout") != records["failed_authority_stdout"]
        or failure_receipt.get("stderr") != records["failed_authority_stderr"]
    ):
        raise RuntimeError("superseded authority process receipt")
    stderr_text = (FAILED_AUTHORITY_EVIDENCE_ROOT / "materializer_stderr.log").read_text(errors="replace")
    if not all(token in stderr_text for token in (
        "materialize_v486_v485_phase_a_static_reconciliation_postregistration_authority.py",
        "line 202, in main",
        "not regular nonsymlink",
        "v486_materializer_failed_invocation_console_capture_reconstructed.txt",
    )):
        raise RuntimeError("superseded missing transcript root cause")
    expected_superseded = {
        **authority_design.get("superseded_authority_materialization", {}),
        "observed_evidence_tree": failure_tree,
    }
    if authority.get("superseded_authority_materialization") != expected_superseded:
        raise RuntimeError("authority superseded materialization ancestry")
    if authority.get("transcript_deployment") != {
        "record": records["deployed_transcript"],
        "missing_during_superseded_attempt": True,
        "present_before_fresh_authority_materialization": True,
    }:
        raise RuntimeError("authority transcript deployment")
    ...
    if (
        ...
        or set(historical_absences) != {
            "qualification_root", "old_phase_a_attempts", "old_phase_a_authority", "transparent_output", "transparent_tmp",
            "superseded_v486_authority_root", "superseded_v486_authority_prep", "superseded_v486_attempt_root",
            "fresh_v487_authority_root", "fresh_v487_authority_prep", "fresh_v487_attempt_root",
        }
        or Path(historical_absences["fresh_v487_authority_root"]["path"]) != AUTHORITY_ROOT
        or Path(historical_absences["superseded_v486_authority_root"]["path"]) != SUPERSEDED_AUTHORITY_ROOT
    ):
    ...
    if (
        ...
        or set(required_absences) != set(expected_historical_absences) - {"fresh_v487_authority_root"}
    ):
...
def synthetic_self_test() -> int:
    with tempfile.TemporaryDirectory(prefix="v486-wrapper-") as directory:
        ...
        checks = {
            ...
            "fresh_v487_lineage_distinct": AUTHORITY_ROOT != SUPERSEDED_AUTHORITY_ROOT and ATTEMPT_ROOT != SUPERSEDED_ATTEMPT_ROOT,
            "deployed_transcript_frozen": DEPLOYED_TRANSCRIPT_SHA == "764f10d36f1cb74be2535f4c442b4eb12f2bc9203e8c285aaf3e3253f6c4b8f9" and DEPLOYED_TRANSCRIPT_BYTES == 514,
        }
        failed_rows = FAILED_AUTHORITY_EVIDENCE_TREE["inventory"]
        failed_lines = "".join(f"{digest}  {relative}\n" for relative, digest, _ in failed_rows).encode()
        failed_compact = json.dumps(failed_rows, separators=(",", ":"), ensure_ascii=False).encode()
        checks["superseded_exact4_tree_contract"] = (
            len(failed_rows) == FAILED_AUTHORITY_EVIDENCE_TREE["file_count"] == 4
            and sum(row[2] for row in failed_rows) == FAILED_AUTHORITY_EVIDENCE_TREE["logical_file_bytes"] == 10625
            and hashlib.sha256(failed_lines).hexdigest() == FAILED_AUTHORITY_EVIDENCE_TREE["sha256sum_lines_digest_sha256"]
            and hashlib.sha256(failed_compact).hexdigest() == FAILED_AUTHORITY_EVIDENCE_TREE["canonical_json_triples_digest_sha256"]
        )
        checks["fresh_authority_check_schema"] = (
            canonical_sha(list(AUTHORITY_CHECK_KEYS)) == AUTHORITY_CHECK_KEYSET_SHA
            and canonical_sha({key: True for key in AUTHORITY_CHECK_KEYS}) == AUTHORITY_CHECKS_SHA
        )
