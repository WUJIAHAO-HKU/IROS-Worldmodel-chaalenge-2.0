#!/usr/bin/env python3
"""Exact-once, signal-safe transport for the v501 inner-binding-repair authority materializer."""
...
SELF_PATH = SCRIPTS / "invoke_v501_v500_failure_tree_diagnostic_inner_binding_repair_execution_authority_materializer_once.py"
SCRIPT_PATH = Path("/root/v501_inner_binding_repair_authority_materialize_once.sh")
CONTRACT = SCRIPTS / "v501_v500_failure_tree_diagnostic_inner_binding_repair_execution_authority_contract.json"
CONTRACT_SHA = "ca5b4f34d67d875752af5c43fd05cd9c0b14c1ad1078fb6049f7dccdcfa46008"
CONTRACT_BYTES = 128175
MATERIALIZER = SCRIPTS / "materialize_v501_v500_inner_binding_repair_execution_authority.py"
MATERIALIZER_SHA = "59e3863c4d1d7b028422cfebb7dfd7fb208526c322d46151ec0010f239d82358"
MATERIALIZER_BYTES = 126045
INNER_WRAPPER = SCRIPTS / "launch_v501_v500_failure_tree_diagnostic_inner_binding_repaired_reconciliation_inner.py"
INNER_WRAPPER_SHA = "6ce84d03f42c1f048684d7128268135aa0a9bb01e7fe7a0e1c1383ec173a3c47"
INNER_WRAPPER_BYTES = 136370
OUTER_WRAPPER = SCRIPTS / "launch_v501_v500_failure_tree_diagnostic_inner_binding_repaired_reconciliation_outer.py"
OUTER_WRAPPER_SHA = "7bf4c56eed59917771c23178d459c698b8c703a40e4e46bf992803490d9f0c5b"
OUTER_WRAPPER_BYTES = 94659
...
EVIDENCE_ROOT = J / "v501_v500_failure_tree_diagnostic_inner_binding_repair_execution_authority_materialization_evidence_seed1643_20260825"
...
def load_materializer():
    ...
    spec = importlib.util.spec_from_file_location("v501_materializer", MATERIALIZER)
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    if (module.CONTRACT_PATH != CONTRACT or module.AUTHORITY_ROOT != AUTHORITY_ROOT
            or set(contract) != module.CONTRACT_TOP_KEYS or contract.get("seed") != 1643
            ...
            or len(module.AUTH_TOP_KEYS) != 107 or len(module.AUTH_CHECK_KEYS) != 96
            or len(module.SOURCE_ROLE_ORDER) != 39
...
def base_receipt(status: str, passed: bool, invocations: int, cleanup: dict, error: BaseException | None = None) -> dict:
    row = {
        "format": "strict-track2-v501-inner-binding-repair-authority-materializer-process-receipt-v1",
...
def orchestrate(*, root: Path, prep: Path, child_argv: list[str], helper_source: Path,
    ...
    try:
        ...
        write_exclusive(prep / "intent.json", cbytes({
            "format": "strict-track2-v501-inner-binding-repair-authority-materializer-intent-v1",
...
def production_fixture() -> dict:
    checks = {}
    with tempfile.TemporaryDirectory(prefix="v501-helper-fixture-") as folder:
        base = Path(folder)
...
def main() -> int:
    ...
    argv = command()
    payload = {
        "format": "strict-track2-v501-inner-binding-repair-authority-materializer-argv-v1",
