#!/usr/bin/env python3
"""One-shot v507 Phase-A cache qualification launcher (design-only source).

The launcher consumes the fresh v507 authority, preserves the frozen v485
...
SEED = 1648
AUTHORITY_CONTRACT = SCRIPTS / "v507_v506_phase_a_cache_qualification_execution_authority_contract.json"
AUTHORITY_MATERIALIZER = SCRIPTS / "materialize_v507_v506_phase_a_cache_qualification_execution_authority.py"
AUTHORITY_MATERIALIZER_SHA = "d0dd3fd09e6874c6a68d857c05fa4e0f1e46606144787e48d97bbfe9fdf54b75"
AUTHORITY_MATERIALIZER_BYTES = 24308
SELF = SCRIPTS / "launch_v507_v506_phase_a_cache_qualification.py"
...
AUTHORITY_FORMAT = "strict-track2-v507-v506-phase-a-cache-qualification-execution-authority-v1"
AUTHORITY_STATUS = "authorized_exact_one_external_v507_phase_a_cache_qualification_attempt"
...
INTENT_FORMAT = "strict-track2-v507-v506-phase-a-cache-qualification-attempt-intent-v1"
TERMINAL_FORMAT = "strict-track2-v507-v506-phase-a-cache-qualification-attempt-terminal-v1"
SOURCE_ORDER = [
...
CHECK_KEYS = [
    ...
    "no_live_phase_a_process", "no_pending_values", "old_exact7_sources_exact", "phase_a_preregistration_exact",
    "phase_a_preregistration_nonauthorizing", "phase_a_static_exact", "phase_a_static_pass_nonauthorizing",
    "qualification_root_absent", "source_aliases_exact", "source_closure_current", "source_order_exact",
    "transparent_pass_check47", "v506_attempt_exact4", "v506_authority_exact1", "v506_authority_schema",
    "v506_materialization_evidence_exact6", "v506_process_partition", "v506_terminal_pass",
]
CONTRACT_TOP_KEYS = {
...
def synthetic_self_test() -> int:
    ...
    checks["source_order"] = len(SOURCE_ORDER) == 14 and len(set(SOURCE_ORDER)) == 14
    ...
    checks["materializer_binding"] = AUTHORITY_MATERIALIZER_SHA in source and AUTHORITY_MATERIALIZER_BYTES == 24308
