...
SEED=1603; VARIANTS=("factual","open","static_transport","reverse_transport","hold_all","factual_duplicate")
...
def main()->int:
 ...
 if len(seeds)!=50 or not set(chosen)<=set(right) or set(chosen)&validation: raise RuntimeError("v450 public-right train seed contract failed")
 contexts=[]
