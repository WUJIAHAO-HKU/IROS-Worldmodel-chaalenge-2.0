...
WRAPPER = SCRIPTS / "launch_v503_v502_compact_single_reconciler.py"
AUTHORITY_CONTRACT = SCRIPTS / "v503_v502_compact_reconciliation_execution_authority_contract.json"
AUTHORITY_MATERIALIZER = SCRIPTS / "materialize_v503_v502_compact_reconciliation_execution_authority.py"
...
ATTEMPT_ROOT = J / "v503_v502_compact_single_reconciler_attempt_seed1645_20260825"
...
V502_AUTHORITY_ROOT = J / "v502_v501_inner_binding_path_repair_execution_authority_seed1644_20260825"
V502_AUTHORITY_RECEIPT = V502_AUTHORITY_ROOT / "authority_receipt.json"
V502_AUTHORITY_SHA = "83e238d5b0c579b7e95ad1cd377021ab5daeb95c2e00af8189768ef28cd4c3e7"
V502_AUTHORITY_BYTES = 314856
V502_MATERIALIZATION_EVIDENCE = J / "v502_v501_inner_binding_path_repair_execution_authority_materialization_evidence_seed1644_20260825"
V502_PROCESS = V502_MATERIALIZATION_EVIDENCE / "process_receipt.json"
V502_PROCESS_SHA = "f3c208ee3af1f09f0e34631cf56379137447b957c6077f73a7d93c0140eef54b"
V502_PROCESS_BYTES = 103043
V502_TRANSPORT_FAILURE = SCRIPTS / "v502_outer_preentry_transport_failure_forensic_reconstructed.json"
V502_TRANSPORT_FAILURE_SHA = "cd399618092399cffdd0f94e084e0a2041d202455c84062250575d075fc28c3e"
V502_TRANSPORT_FAILURE_BYTES = 8336
V502_ANCESTRY_FAILURE = SCRIPTS / "v503_v502_outer_preintent_v494_ancestry_failure_forensic_reconstructed.json"
V502_ANCESTRY_FAILURE_SHA = "418f399030a0f0e13571c38a8e55ac36de45d2012616adef49d7452ab90a4ce9"
V502_ANCESTRY_FAILURE_BYTES = 8521
V504_FAILURE = SCRIPTS / "v504_v503_v502_v485_alias_restore_pre_evidence_failure_forensic_reconstructed.json"
V504_FAILURE_SHA = "f04127d6e9b78860ddb873e3cb660e56c8f27141e0383bcfbf9aa6c7ee7709d8"
V504_FAILURE_BYTES = 4772
V504_DESIGN = SCRIPTS / "v504_v503_v502_v485_volatile_static_log_alias_restore_design.json"
V504_DESIGN_SHA = "509d5badb6a7c0eefced7dd92f41fc16ffd8da63a8cce5884a473ec12af3155d"
V504_DESIGN_BYTES = 5617
V504_HELPER = Path("/root/restore_v504_v503_v485_volatile_static_log_alias_once.py")
V504_HELPER_SHA = "9860843f8aa01e7665f02bddfa975efcf0d382cae4ad47f228fb630b2b046530"
V504_HELPER_BYTES = 38626
V504_SCRIPT = Path("/root/v504_restore_v485_volatile_static_log_alias_once.sh")
V504_SCRIPT_SHA = "825fafea3f59f84b4f8d2d98cd790e2de8579de51d5f8ac36cded277baff57ca"
V504_SCRIPT_BYTES = 4077
V504_EVIDENCE = J / "v504_v503_v502_v485_volatile_static_log_alias_restore_evidence_seed1646_20260825"
V504_PROCESS = V504_EVIDENCE / "process_receipt.json"
V504_PROCESS_SHA = "aaf5b944b93d94ca818712737b20289445d9ba6e9712bd0d42f9c38ab305b6d2"
V504_PROCESS_BYTES = 22747
V504_TARGET = Path("/dev/shm/v485_static_b73.log")
...
AUTHORITY_FORMAT = "strict-track2-v503-v502-compact-reconciliation-execution-authority-v1"
AUTHORITY_STATUS = "authorized_exact_one_external_compact_single_reconciler_attempt"
INTENT_FORMAT = "strict-track2-v503-v502-compact-single-reconciler-attempt-intent-v1"
TERMINAL_FORMAT = "strict-track2-v503-v502-compact-single-reconciler-attempt-terminal-v1"

CONTRACT_TOP_KEYS = {
    "authority_materializer_source", "authority_receipt_contract", "authorization",
    "current_absences_after_authority", "execution_boundary", "f813_registration_tree",
    "format", "historical_absences", "lineage", "phase_a_design_contract_record",
    "postregistration_static_record", "repair_formal_record", "seed", "source_aliases",
    "source_closure", "source_closure_sha256", "source_role_order", "status",
    "v502_authority_materialization_evidence_tree", "v502_authority_materializer_process_receipt",
    "v502_authority_receipt", "v502_authority_registration_tree", "v502_failure_ancestry",
    "v502_failure_summary", "runtime_observation",
...
def write_noreplace(path: Path, value: object, publish_state: dict | None = None, fault_hook=None) -> dict:
    temporary = path.with_name("." + path.name + ".v503.tmp")
...
def validate_v502_anchors(contract: dict, authority: dict) -> dict:
    authority_record = regular(V502_AUTHORITY_RECEIPT, V502_AUTHORITY_SHA, V502_AUTHORITY_BYTES)
    authority_tree = exact_tree(V502_AUTHORITY_ROOT)
    if authority_tree["file_count"] != 1 or authority_tree["inventory"] != [["authority_receipt.json", V502_AUTHORITY_SHA, V502_AUTHORITY_BYTES]]:
        raise RuntimeError("v502 authority exact1")
    evidence_tree = exact_tree(V502_MATERIALIZATION_EVIDENCE)
    if (evidence_tree["file_count"], evidence_tree["logical_file_bytes"], evidence_tree["sha256sum_lines_digest_sha256"], evidence_tree["canonical_json_triples_digest_sha256"]) != (
        6, 203571, "64045a24ece15e26976af33c79a71b6aca720bce47e3293d96fffe5b62cf9e4f", "f05e1f5e2490eb015926f2a2aabcc351e1102c5d46566e435658dc217e08a70f"
    ):
        raise RuntimeError("v502 materialization exact6")
    process_record = regular(V502_PROCESS, V502_PROCESS_SHA, V502_PROCESS_BYTES)
    process = json.loads(V502_PROCESS.read_text())
    if process.get("passed") is not True or process.get("authority_materializer_invocations") != 1:
        raise RuntimeError("v502 process")
    if any(process.get(key) != 0 for key in ("outer_wrapper_invocations", "corrected_inner_wrapper_invocations", "reconciler_r2_invocations")):
        raise RuntimeError("v502 process partition")
    if process.get("retry_authorized") is not False or process.get("pre_post_snapshots_exactly_equal") is not True:
        raise RuntimeError("v502 process boundary")
    if process.get("cleanup", {}).get("reaped") is not True or process.get("cleanup", {}).get("group_empty") is not True:
        raise RuntimeError("v502 process cleanup")

    transport_record = regular(V502_TRANSPORT_FAILURE, V502_TRANSPORT_FAILURE_SHA, V502_TRANSPORT_FAILURE_BYTES)
    ancestry_record = regular(V502_ANCESTRY_FAILURE, V502_ANCESTRY_FAILURE_SHA, V502_ANCESTRY_FAILURE_BYTES)
    transport = json.loads(V502_TRANSPORT_FAILURE.read_text())
    ancestry = json.loads(V502_ANCESTRY_FAILURE.read_text())
    if transport.get("status") != "frozen_reconstructed_preentry_transport_failure_outer_attempt_not_consumed_corrected_transport_pending_review":
        raise RuntimeError("v502 transport failure")
    if transport.get("invocation_partition_after_failure", {}).get("outer_wrapper_invocations") != 0:
        raise RuntimeError("v502 transport partition")
    if ancestry.get("status") != "frozen_reconstructed_v502_outer_preintent_v494_ancestry_failure_no_retry":
        raise RuntimeError("v502 ancestry failure")
    if ancestry.get("invocation_partition") != {
        "corrected_inner_wrapper_invocations": 0, "outer_wrapper_invocations": 1,
        "phase_a_invocations": 0, "reconciler_r2_invocations": 0, "training_invocations": 0,
    }:
        raise RuntimeError("v502 ancestry partition")
    if [row.get("passed") for row in ancestry.get("combined_predicate_evaluation", [])] != [True, True, True, False] or len(ancestry.get("json_leaf_diff", [])) != 2:
        raise RuntimeError("v502 ancestry exact diff")
    ...
    if contract.get("v502_failure_summary") != ancestry_record or authority.get("v502_failure_summary") != ancestry_record:
        raise RuntimeError("v502 failure summary alias")
    if contract.get("v502_failure_ancestry") != expected_failure_ancestry or authority.get("v502_failure_ancestry") != expected_failure_ancestry:
        raise RuntimeError("v502 failure ancestry alias")
    aliases = {
        "v502_authority_receipt": authority_record,
        "v502_authority_registration_tree": authority_tree,
        "v502_authority_materialization_evidence_tree": evidence_tree,
        "v502_authority_materializer_process_receipt": process_record,
    }
    if any(contract.get(key) != value or authority.get(key) != value for key, value in aliases.items()):
        raise RuntimeError("v502 authority aliases")

    v504_failure_record = regular(V504_FAILURE, V504_FAILURE_SHA, V504_FAILURE_BYTES)
    v504_design_record = regular(V504_DESIGN, V504_DESIGN_SHA, V504_DESIGN_BYTES)
    v504_helper_record = regular(V504_HELPER, V504_HELPER_SHA, V504_HELPER_BYTES)
    v504_script_record = regular(V504_SCRIPT, V504_SCRIPT_SHA, V504_SCRIPT_BYTES)
    v504_evidence = exact_tree(V504_EVIDENCE)
    v504_process_record = regular(V504_PROCESS, V504_PROCESS_SHA, V504_PROCESS_BYTES)
    v504_target_record = regular(V504_TARGET, F813_LOG_SHA, F813_LOG_BYTES)
    v504_failure = json.loads(V504_FAILURE.read_text())
    v504_process = json.loads(V504_PROCESS.read_text())
    v504_ancestry = {
    ...
    if (
        ...
        or any(v504_process.get(key) != 0 for key in (
            "direct_reconciler_wrapper_invocations", "reconciler_r2_invocations",
            "phase_a_invocations", "training_invocations",
        ))
    ...
    v504_aliases = {
        "v504_restore_failure_forensic": v504_failure_record,
        "v504_restore_design": v504_design_record,
        "v504_restore_helper": v504_helper_record,
        "v504_restore_script": v504_script_record,
        "v504_restore_evidence_tree": v504_evidence,
        "v504_restore_process_receipt": v504_process_record,
        "v504_restored_target": v504_target_record,
        "v504_restore_ancestry": v504_ancestry,
    }
    if any(contract.get(key) != value or authority.get(key) != value for key, value in v504_aliases.items()):
        raise RuntimeError("v504 authority aliases")
    return {
        **aliases, **v504_aliases, "failure_summary": ancestry_record,
        "failure_ancestry": expected_failure_ancestry, "transport_failure": transport_record,
    }
...
def validate_compact_authority(args: argparse.Namespace) -> dict:
    ...
    if set(contract) != CONTRACT_TOP_KEYS or contract.get("format") != CONTRACT_FORMAT or contract.get("status") != CONTRACT_STATUS or contract.get("seed") != 1645:
    ...
    anchors = validate_v502_anchors(contract, authority)
    lineage = {
        "fresh_authority_root": str(AUTHORITY_ROOT),
        "fresh_wrapper_attempt_root": str(ATTEMPT_ROOT),
        "name": "v503_v502_compact_reconciliation",
        "supersedes_v502_retry": True,
    }
    ...
    return {
        ...
        "sources": observed, "anchors": anchors, "f813_before": f813_tree,
    }
...
def immutable_snapshot(context: dict) -> dict:
    ...
    files = {
        ...
        "v502_authority": regular(V502_AUTHORITY_RECEIPT, V502_AUTHORITY_SHA, V502_AUTHORITY_BYTES),
        "v502_process": regular(V502_PROCESS, V502_PROCESS_SHA, V502_PROCESS_BYTES),
        "v502_transport_failure": regular(V502_TRANSPORT_FAILURE, V502_TRANSPORT_FAILURE_SHA, V502_TRANSPORT_FAILURE_BYTES),
        "v502_ancestry_failure": regular(V502_ANCESTRY_FAILURE, V502_ANCESTRY_FAILURE_SHA, V502_ANCESTRY_FAILURE_BYTES),
        "v504_restore_failure": regular(V504_FAILURE, V504_FAILURE_SHA, V504_FAILURE_BYTES),
        "v504_restore_design": regular(V504_DESIGN, V504_DESIGN_SHA, V504_DESIGN_BYTES),
        "v504_restore_helper": regular(V504_HELPER, V504_HELPER_SHA, V504_HELPER_BYTES),
        "v504_restore_script": regular(V504_SCRIPT, V504_SCRIPT_SHA, V504_SCRIPT_BYTES),
        "v504_restore_process": regular(V504_PROCESS, V504_PROCESS_SHA, V504_PROCESS_BYTES),
        "v504_restored_target": regular(V504_TARGET, F813_LOG_SHA, F813_LOG_BYTES),
        "f813_preregistration": regular(F813, F813_SHA, F813_BYTES),
        "f813_log": regular(F813_LOG, F813_LOG_SHA, F813_LOG_BYTES),
    }
    trees = {
        "v502_authority": exact_tree(V502_AUTHORITY_ROOT),
        "v502_materialization": exact_tree(V502_MATERIALIZATION_EVIDENCE),
        "v504_restore_evidence": exact_tree(V504_EVIDENCE),
...
def execute(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        intent = {
            ...
            "v502_failure_summary": context["anchors"]["failure_summary"],
            "v502_failure_ancestry": context["anchors"]["failure_ancestry"],
...
def synthetic_self_test() -> int:
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="v503-compact-lifecycle-") as raw:
            ...
            foreign_json_temp = foreign_json_root / ".intent.json.v503.tmp"
