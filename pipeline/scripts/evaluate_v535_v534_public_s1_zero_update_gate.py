...
SEED = 1668
FORMAT = "strict-track2-v535-v534-public-s1-zero-update-gate-execution-receipt-v1"
...
ACTIVE_SOURCE_PATHS = {
    "authority_design_contract": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/v535_v534_public_s1_zero_update_gate_execution_authority_contract.json",
    "authority_materializer": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/materialize_v535_v534_public_s1_zero_update_gate_execution_authority.py",
    "public_s1_zero_update_preregistration": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/v535_v534_public_s1_zero_update_gate_preregistration.json",
    "public_s1_zero_update_manifest": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/v535_v534_public_s1_zero_update_gate_manifest.json",
    "public_s1_evaluator": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/evaluate_v535_v534_public_s1_zero_update_gate.py",
    "public_s1_independent_auditor": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/audit_v535_v534_public_s1_zero_update_gate.py",
    "public_s1_launcher": "/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/launch_v535_v534_public_s1_zero_update_gate.py",
}
...
def validate_documents(prereg, manifest, contract, authority, args, *, require_fresh: bool = True) -> None:
    if (set(prereg)!=PREREG_KEYS or set(manifest)!=MANIFEST_KEYS or set(contract)!=CONTRACT_KEYS
            or prereg.get("format")!="strict-track2-v535-v534-public-s1-zero-update-gate-preregistration-v1"
            or manifest.get("format")!="strict-track2-v535-v534-public-s1-zero-update-gate-manifest-v1"
            or contract.get("format")!="strict-track2-v535-v534-public-s1-zero-update-gate-execution-authority-design-contract-v1"
    ...
    for field in ("v534_actual_oof_durable_transition", "public_s1_input_contract", "public_s1_output_contract", "zero_update_contract", "hidden_input_denial_contract"):
    ...
    for field,receipt_field in (("v534_actual_oof_durable_transition","v534_actual_oof_durable_transition_exact"),("public_s1_input_contract","public_s1_input_contract_exact"),("public_s1_output_contract","public_s1_output_contract_exact"),("zero_update_contract","zero_update_contract_exact"),("hidden_input_denial_contract","hidden_input_denial_contract_exact"),("execution_boundary","execution_boundary_exact"),("runtime_observation","runtime_observation_exact")):
...
def load_v169_runtime(manifest, device):
    ...
    pipeline_root=str(source.parents[1])
    if pipeline_root not in sys.path: sys.path.insert(0,pipeline_root)
    spec = importlib.util.spec_from_file_location("v535_public_v169_runtime", source)
...
def execute(args) -> dict:
    ...
    try:
        ...
        held_json(prep/"attempt_intent.json", {"format":"strict-track2-v535-v534-public-s1-zero-update-attempt-intent-v1","seed":SEED,"literal_argv":args.literal_argv,"rng_entry":rng_entry,"authority_receipt_sha256":args.authority_receipt_sha},held)
        ...
        with torch.inference_mode():
            with torch.no_grad():
                for frozen in manifest["public_s1_input_contract"]["ordered_rows"]:
                    ...
                    loaded=load_public_row(frozen); prediction=predict_public(runtime,frozen,loaded); target=loaded["target"]
