#!/usr/bin/env python3
"""Fresh exact-once v521 transport for the frozen v520 authority materializer."""
...
SELF_PATH = SCRIPTS / "invoke_v521_v520_phase_a_rng_isolated_qualification_execution_authority_materializer_once.py"
SCRIPT_PATH = Path("/root/v521_v520_phase_a_rng_isolated_qualification_authority_materialize_once.sh")
FAILURE_FORENSIC = SCRIPTS / "v521_v520_authority_transport_collection_failure_forensic.json"
FAILURE_FORENSIC_SHA = "ebb1ca52ec8f96cb1903b7e1955485a07eeeb77fd8e4b5373415e38fc8dd1d6a"
FAILURE_FORENSIC_BYTES = 9234
OLD_HELPER = SCRIPTS / "invoke_v520_v519_phase_a_rng_isolated_qualification_execution_authority_materializer_once.py"
OLD_HELPER_SHA = "67fd05c36cfdc6b394e4facc711438f1b88a8230d9075770ae760c8090ab8a36"
OLD_HELPER_BYTES = 65029
OLD_SCRIPT = Path("/root/v520_v519_phase_a_rng_isolated_qualification_authority_materialize_once.sh")
OLD_SCRIPT_SHA = "6fb71a4ee1b1cd406f009e4c6a20a6c1eab21ebb7fafc02b91fc5ea3c643fe16"
OLD_SCRIPT_BYTES = 2575
CONTRACT = SCRIPTS / "v520_v519_phase_a_rng_isolated_qualification_execution_authority_contract.json"
CONTRACT_SHA = "58d1ccda8277aa58d3606eff9c21546aa6f67900a6153fe28d725e928f370d80"
CONTRACT_BYTES = 88570
MATERIALIZER = SCRIPTS / "materialize_v520_v519_phase_a_rng_isolated_qualification_execution_authority.py"
MATERIALIZER_SHA = "fcf766f26fbd2d06abd9e7c1def44570d0380e5aadd9fbbce63932b4438c823d"
MATERIALIZER_BYTES = 33210
PHASE_A_LAUNCHER = SCRIPTS / "launch_v520_v519_phase_a_cache_qualification.py"
PHASE_A_LAUNCHER_SHA = "3ba99011c1a43e8fa38d9ebf04e011f48ebcdf0919e718413041dba4e867d36f"
PHASE_A_LAUNCHER_BYTES = 64163
PHASE_A_DRIVER = SCRIPTS / "generate_v520_v519_phase_a_cache_qualification.py"
PHASE_A_DRIVER_SHA = "4a6afa63b5ef8eff84dd0a197e914ac96a4d32c8f1ac543014810b7949249a05"
PHASE_A_DRIVER_BYTES = 45542
PHASE_A_WORKER = SCRIPTS / "generate_v520_v519_phase_a_cache_qualification_worker.py"
PHASE_A_WORKER_SHA = "deff45645f6ba4f650200d0d8d408f01ab107d1ff74eeb041eaa0a70fcf29e7b"
PHASE_A_WORKER_BYTES = 38774
...
INDEPENDENT_AUDITOR = SCRIPTS / "audit_v520_v519_phase_a_rng_isolated_qualification.py"
INDEPENDENT_AUDITOR_SHA = "6964cc0120489add4ba7397ea7bc1b43bb393ea75ba52e4d588031cbab460f42"
INDEPENDENT_AUDITOR_BYTES = 45074
...
EVIDENCE_ROOT = J / "v521_v520_phase_a_rng_isolated_qualification_execution_authority_materialization_evidence_seed1657_20260826"
...
def v520_phase_a_pids() -> list[dict]:
    markers = ("launch_v520_v519_phase_a_cache_qualification.py",
               "generate_v520_v519_phase_a_cache_qualification.py",
               "generate_v520_v519_phase_a_cache_qualification_worker.py")
    rows = []
...
def validate_transport_failure_forensic(value: dict) -> None:
    top_keys = {"format", "status", "passed", "captured_at_date", "boot_id", "root_cause",
                "outer_invocation", "inner_selftest", "execution_partition", "deployed_exact10",
                "roots_after_failure", "service_health", "gpu_compute_pids", "lineage_pids",
                "retry_authorized"}
    root_cause_keys = {"stage", "inner_selftest_completed_successfully", "inner_selftest_source_exit_code",
                       "outer_transport_nonzero", "outer_numeric_returncode",
                       "outer_numeric_returncode_availability", "cause", "no_helper_or_materializer_entry"}
    outer_keys = {"executable", "argv", "merged_tool_capture_exact", "stderr_exact", "tool_exception"}
    inner_keys = {"argv", "invocation_scope", "tool_recorded_outer_command_issued_invocations",
                  "global_invocation_count_native_evidence_available", "global_exact_invocation_count_claimed",
                  "stdout", "stderr", "source_exit_zero_proof"}
    partition_keys = {"scope", "atomic_deploy_count_scope",
                      "recorded_authorized_sequence_atomic_deploy_invocations",
                      "recorded_authorized_sequence_atomic_deploy_targets", "transport_selftest_count_scope",
                      "tool_recorded_outer_command_issued_selftest_invocations",
                      "global_invocation_count_native_evidence_available", "global_exact_invocation_count_claimed",
                      "normal_script_invocations", "transport_helper_invocations",
                      "authority_materializer_invocations", "phase_a_launcher_invocations",
                      "phase_a_driver_invocations", "phase_a_worker_invocations",
                      "rng_proxy_delegate_invocations", "training_invocations", "retry_authorized"}
    partition = value.get("execution_partition", {})
    inner = value.get("inner_selftest", {})
    stdout = value.get("inner_selftest", {}).get("stdout", {})
    stderr = value.get("inner_selftest", {}).get("stderr", {})
    deployed = value.get("deployed_exact10", {})
    expected_deployed = {
        "authority_contract": {"path": str(CONTRACT), "sha256": CONTRACT_SHA, "logical_bytes": CONTRACT_BYTES},
        "authority_materializer": {"path": str(MATERIALIZER), "sha256": MATERIALIZER_SHA, "logical_bytes": MATERIALIZER_BYTES},
        "phase_a_launcher": {"path": str(PHASE_A_LAUNCHER), "sha256": PHASE_A_LAUNCHER_SHA, "logical_bytes": PHASE_A_LAUNCHER_BYTES},
        "phase_a_driver": {"path": str(PHASE_A_DRIVER), "sha256": PHASE_A_DRIVER_SHA, "logical_bytes": PHASE_A_DRIVER_BYTES},
        "phase_a_worker": {"path": str(PHASE_A_WORKER), "sha256": PHASE_A_WORKER_SHA, "logical_bytes": PHASE_A_WORKER_BYTES},
        "rng_proxy": {"path": str(RNG_PROXY), "sha256": RNG_PROXY_SHA, "logical_bytes": RNG_PROXY_BYTES},
        "independent_auditor": {"path": str(INDEPENDENT_AUDITOR), "sha256": INDEPENDENT_AUDITOR_SHA, "logical_bytes": INDEPENDENT_AUDITOR_BYTES},
        "preregistration": {"path": str(PREREG), "sha256": PREREG_SHA, "logical_bytes": PREREG_BYTES},
        "old_transport_helper": {"path": str(OLD_HELPER), "sha256": OLD_HELPER_SHA, "logical_bytes": OLD_HELPER_BYTES},
        "old_transport_script": {"path": str(OLD_SCRIPT), "sha256": OLD_SCRIPT_SHA, "logical_bytes": OLD_SCRIPT_BYTES},
    }
    zero_fields = ("normal_script_invocations", "transport_helper_invocations",
                   "authority_materializer_invocations", "phase_a_launcher_invocations",
                   "phase_a_driver_invocations", "phase_a_worker_invocations",
                   "rng_proxy_delegate_invocations", "training_invocations")
    roots = value.get("roots_after_failure", [])
    root_paths = {row.get("path") for row in roots if isinstance(row, dict)}
    required_roots = {
        str(AUTHORITY_ROOT), str(AUTHORITY_PREP),
        str(J / "v520_v519_phase_a_rng_isolated_qualification_execution_authority_materialization_evidence_seed1656_20260826"),
        str(J / "v520_v519_phase_a_rng_isolated_qualification_execution_authority_materialization_evidence_seed1656_20260826.execution-prep"),
        str(J / "v520_v519_phase_a_cache_qualification_attempt_seed1656_20260826"),
        str(J / "v520_v519_phase_a_cache_qualification_attempt_seed1656_20260826.attempt-prep"),
        "/root/v520_v519_phase_a_cache_qualification_seed1656_20260826",
        "/root/v520_v519_phase_a_cache_qualification_seed1656_20260826.attempt-prep",
    }
    count_values = [partition.get(key) for key in zero_fields] + [
        partition.get("recorded_authorized_sequence_atomic_deploy_invocations"),
        partition.get("recorded_authorized_sequence_atomic_deploy_targets"),
        partition.get("tool_recorded_outer_command_issued_selftest_invocations"),
        inner.get("tool_recorded_outer_command_issued_invocations"),
        value.get("root_cause", {}).get("inner_selftest_source_exit_code")]
    if (set(value) != top_keys or set(value.get("root_cause", {})) != root_cause_keys
            or set(value.get("outer_invocation", {})) != outer_keys or set(inner) != inner_keys
            or set(partition) != partition_keys
            or set(inner.get("stdout", {})) != {"sha256", "logical_bytes", "text"}
            or set(inner.get("stderr", {})) != {"sha256", "logical_bytes", "text"}
            or set(inner.get("source_exit_zero_proof", {})) != {"script_sha256", "script_logical_bytes", "branch"}
            or any(type(item) is not int for item in count_values)
            or any(not isinstance(row, dict) or set(row) != {"path", "sha256", "logical_bytes"}
                   for row in deployed.values())
            or any(not isinstance(row, dict) or set(row) != {"path", "absent"} for row in roots)
            or value.get("format") != "strict-track2-v521-v520-authority-transport-collection-failure-forensic-v1"
            or value.get("status") != "immutable_prehelper_transport_collection_failure_no_retry"
            or value.get("passed") is not False or value.get("retry_authorized") is not False
            or value.get("root_cause", {}).get("inner_selftest_completed_successfully") is not True
            or value.get("root_cause", {}).get("inner_selftest_source_exit_code") != 0
            or value.get("root_cause", {}).get("outer_transport_nonzero") is not True
            or value.get("root_cause", {}).get("outer_numeric_returncode") is not None
            or value.get("root_cause", {}).get("no_helper_or_materializer_entry") is not True
            or value.get("outer_invocation", {}).get("stderr_exact") != "bash: line 2: exit: \\: numeric argument required"
            or inner.get("invocation_scope") != "sole_recorded_outer_tool_command"
            or inner.get("tool_recorded_outer_command_issued_invocations") != 1
            or inner.get("global_invocation_count_native_evidence_available") is not False
            or inner.get("global_exact_invocation_count_claimed") is not False
            or stdout.get("sha256") != "3f16cba8d843647103957ca6fcf84e443763d1fe6711c99da579bb3f4f0baa5e"
            or stdout.get("logical_bytes") != 506
            or stderr != {"sha256": hashlib.sha256(b"").hexdigest(), "logical_bytes": 0, "text": ""}
            or partition.get("scope") != "recorded_authorized_sequence_tool_capture_only_not_global_process_accounting"
            or partition.get("atomic_deploy_count_scope") != "recorded_authorized_sequence"
            or partition.get("recorded_authorized_sequence_atomic_deploy_invocations") != 1
            or partition.get("recorded_authorized_sequence_atomic_deploy_targets") != 10
            or partition.get("transport_selftest_count_scope") != "sole_recorded_outer_tool_command"
            or partition.get("tool_recorded_outer_command_issued_selftest_invocations") != 1
            or partition.get("global_invocation_count_native_evidence_available") is not False
            or partition.get("global_exact_invocation_count_claimed") is not False
            or any(partition.get(key) != 0 for key in zero_fields)
            or partition.get("retry_authorized") is not False
            or deployed != expected_deployed or len(roots) != 8 or root_paths != required_roots
            or not all(row.get("absent") is True and not os.path.lexists(row.get("path", "")) for row in roots)
            or value.get("gpu_compute_pids") != [] or value.get("lineage_pids") != []):
        raise RuntimeError("v520 transport collection failure forensic")
...
def immutable_snapshot(contract: dict, helper_record: dict, script_record: dict) -> dict:
    ...
    forensic_record = regular(FAILURE_FORENSIC, (FAILURE_FORENSIC_SHA, FAILURE_FORENSIC_BYTES))
    forensic = json.loads(FAILURE_FORENSIC.read_text(encoding="utf-8"))
    validate_transport_failure_forensic(forensic)
    return {
        ...
        "prior_transport_failure_forensic": forensic_record,
        "old_transport_helper": regular(OLD_HELPER, (OLD_HELPER_SHA, OLD_HELPER_BYTES)),
        "old_transport_script": regular(OLD_SCRIPT, (OLD_SCRIPT_SHA, OLD_SCRIPT_BYTES)),
        "sources": sources, "trees": trees, "absences": absences,
        "service_health": service_health(), "gpu_compute_pids": gpu_compute_pids(),
        "v520_phase_a_pids": v520_phase_a_pids(),
    }
...
def validate_materializer_contract(module, contract: dict, materializer_record: dict) -> None:
    ...
    if (module.CONTRACT_PATH != CONTRACT or module.AUTHORITY_ROOT != AUTHORITY_ROOT
            ...
            or isinstance(seed, bool) or not isinstance(seed, int) or seed != 1656
            ...
            or len(contract.get("authority_receipt_contract", {}).get("top_keys", [])) != 68
            or len(module.CHECK_KEYS) != 33
            or len(module.CONTRACT_SOURCE_ORDER) != 22 or len(module.AUTHORITY_SOURCE_ORDER) != 23
    ...
    _old, base = module.load_base()
    closure = contract["source_closure"]
    module.validate_prereg(closure)
    module.validate_v519(base)
    module.validate_v517(base)
    module.validate_failures()
    if contract.get("worker_environment_exact") != module.WORKER_ENV or contract.get("per_call_rng_evidence_contract") != module.PER_CALL_RNG_CONTRACT:
        raise RuntimeError("v520 execution contract")
...
def load_materializer(contract_source: Path = CONTRACT, materializer_source: Path = MATERIALIZER,
    ...
    spec = importlib.util.spec_from_file_location("v520_materializer", materializer_source)
...
def validate_success(module, contract: dict, returncode: int, cleanup: dict,
    ...
    if (os.path.lexists(AUTHORITY_PREP)
            or sorted(receipt) != receipt_schema["top_keys"] or len(receipt) != 68
            ...
            or len(receipt.get("source_closure", {})) != 23
...
def base_receipt(status: str, passed: bool, invocations: int, cleanup: dict, error: BaseException | None = None) -> dict:
    row = {
        "format": "strict-track2-v521-v520-phase-a-rng-isolated-qualification-authority-materializer-process-receipt-v1",
...
def orchestrate(*, root: Path, prep: Path, child_argv: list[str], helper_source: Path,
    ...
    try:
        ...
        write_exclusive(prep / "intent.json", cbytes({
            "format": "strict-track2-v521-v520-phase-a-rng-isolated-qualification-authority-materializer-intent-v1",
        ...
        if failure_forensic_record is not None:
            receipt["prior_transport_failure_forensic"] = failure_forensic_record
        ...
        if promoted:
            ...
            if not state["committed"]:
                ...
                if failure_forensic_record is not None:
                    failure["prior_transport_failure_forensic"] = failure_forensic_record
...
def production_fixture(contract_source: Path = CONTRACT, materializer_source: Path = MATERIALIZER,
                       prereg_source: Path | None = None,
                       failure_forensic_source: Path = FAILURE_FORENSIC) -> dict:
    checks = {}
    forensic_record = regular(failure_forensic_source, (FAILURE_FORENSIC_SHA, FAILURE_FORENSIC_BYTES))
    forensic = json.loads(failure_forensic_source.read_text(encoding="utf-8"))
    validate_transport_failure_forensic(forensic)
    checks["failure_forensic_exact_and_old_transport_bound"] = (
        forensic_record["sha256"] == FAILURE_FORENSIC_SHA
        and forensic["deployed_exact10"]["old_transport_helper"] == {
            "path": str(OLD_HELPER), "sha256": OLD_HELPER_SHA, "logical_bytes": OLD_HELPER_BYTES}
        and forensic["deployed_exact10"]["old_transport_script"] == {
            "path": str(OLD_SCRIPT), "sha256": OLD_SCRIPT_SHA, "logical_bytes": OLD_SCRIPT_BYTES})
    forensic_tampers = []
    for mutation in ("retry", "normal", "helper", "materializer", "stdout", "root",
                     "inner_scope", "inner_global_claim", "partition_scope", "partition_global_available",
                     "legacy_inner_extra", "legacy_partition_extra", "unknown_inner_extra",
                     "unknown_partition_extra", "one_is_bool", "zero_is_bool"):
        bad = copy.deepcopy(forensic)
        if mutation == "retry": bad["execution_partition"]["retry_authorized"] = True
        elif mutation == "normal": bad["execution_partition"]["normal_script_invocations"] = 1
        elif mutation == "helper": bad["execution_partition"]["transport_helper_invocations"] = 1
        elif mutation == "materializer": bad["execution_partition"]["authority_materializer_invocations"] = 1
        elif mutation == "stdout": bad["inner_selftest"]["stdout"]["sha256"] = "0" * 64
        elif mutation == "root": bad["roots_after_failure"][0]["absent"] = False
        elif mutation == "inner_scope": bad["inner_selftest"]["invocation_scope"] = "global"
        elif mutation == "inner_global_claim": bad["inner_selftest"]["global_exact_invocation_count_claimed"] = True
        elif mutation == "partition_scope": bad["execution_partition"]["atomic_deploy_count_scope"] = "global"
        elif mutation == "partition_global_available": bad["execution_partition"]["global_invocation_count_native_evidence_available"] = True
        elif mutation == "legacy_inner_extra": bad["inner_selftest"]["invocations"] = 1
        elif mutation == "legacy_partition_extra": bad["execution_partition"]["transport_selftest_invocations"] = 1
        elif mutation == "unknown_inner_extra": bad["inner_selftest"]["unexpected"] = None
        elif mutation == "unknown_partition_extra": bad["execution_partition"]["unexpected"] = None
        elif mutation == "one_is_bool": bad["inner_selftest"]["tool_recorded_outer_command_issued_invocations"] = True
        else: bad["execution_partition"]["normal_script_invocations"] = False
        try:
            validate_transport_failure_forensic(bad)
            forensic_tampers.append(False)
        except RuntimeError:
            forensic_tampers.append(True)
    checks["failure_forensic_partition_tampers_rejected"] = all(forensic_tampers) and len(forensic_tampers) == 16
    ...
    checks["final8_and_prior_transport_hardbound"] = all(value in source for value in (
        CONTRACT_SHA, MATERIALIZER_SHA, PHASE_A_LAUNCHER_SHA, PHASE_A_DRIVER_SHA,
        PHASE_A_WORKER_SHA, RNG_PROXY_SHA, INDEPENDENT_AUDITOR_SHA, PREREG_SHA,
        FAILURE_FORENSIC_SHA, OLD_HELPER_SHA, OLD_SCRIPT_SHA))
    ...
    def rejects(contract_value, module_value=live_module, materializer_value=live_materializer_record):
        try:
            ...
            return True
    tamper_checks = []
    for bad_seed in (1655, 1657, "1656", True, None):
    ...
    tamper_checks.append(rejects(bad_worker))
    module_values = {name: getattr(live_module, name) for name in (
        ...
        "PER_CALL_RNG_CONTRACT", "load_base", "validate_prereg", "validate_v519", "validate_v517", "validate_failures")}
    ...
    checks["actual_load_materializer_tamper_suite"] = all(tamper_checks) and len(tamper_checks) == 11
    with tempfile.TemporaryDirectory(prefix="v520-helper-fixture-") as folder:
        base = Path(folder)
...
def main() -> int:
    ...
    failure_forensic_record = regular(FAILURE_FORENSIC, (FAILURE_FORENSIC_SHA, FAILURE_FORENSIC_BYTES))
    validate_transport_failure_forensic(json.loads(FAILURE_FORENSIC.read_text(encoding="utf-8")))
    old_helper_record = regular(OLD_HELPER, (OLD_HELPER_SHA, OLD_HELPER_BYTES))
    old_script_record = regular(OLD_SCRIPT, (OLD_SCRIPT_SHA, OLD_SCRIPT_BYTES))
    pre = immutable_snapshot(contract, helper_record, script_record)
    if pre["gpu_compute_pids"] or pre["v520_phase_a_pids"]:
    ...
    argv = command()
    payload = {
        "format": "strict-track2-v521-v520-phase-a-rng-isolated-qualification-authority-materializer-argv-v1",
        ...
        "transport_helper": helper_record,
        "prior_transport_failure_forensic": failure_forensic_record,
        "old_transport_helper": old_helper_record, "old_transport_script": old_script_record,
    ...
    result = orchestrate(root=EVIDENCE_ROOT, prep=EVIDENCE_PREP, child_argv=argv,
                         ...
                         argv_payload=payload, timeout=300,
                          ...
                          retain_terminal_priority=True,
                          failure_forensic_record=failure_forensic_record)
