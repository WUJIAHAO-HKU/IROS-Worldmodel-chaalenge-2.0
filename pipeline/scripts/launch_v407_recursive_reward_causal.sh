...
RUN="$J/v407_one_chunk_progressive_seed1565_20260823"
REG="$O/run_registry/v407_one_chunk_progressive_seed1565_20260823"
...
set +e
taskset -c 0-11 "$PY" "$ROOT/pipeline/scripts/audit_v407_recursive_reward_causal.py" \
...
echo "V407_RECURSIVE_AUDIT_EXIT=$status"
exit "$status"
