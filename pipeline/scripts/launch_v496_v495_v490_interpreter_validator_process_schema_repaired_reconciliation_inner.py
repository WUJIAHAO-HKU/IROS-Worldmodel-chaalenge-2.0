...
WRAPPER_PATH=ROOT/"pipeline/scripts/launch_v496_v495_v490_interpreter_validator_process_schema_repaired_reconciliation_inner.py"
AUTHORITY_CONTRACT_PATH=ROOT/"pipeline/scripts/v496_v495_v490_interpreter_validator_process_schema_repair_execution_authority_contract.json"
...
OUTER_WRAPPER_PATH=ROOT/"pipeline/scripts/launch_v496_v495_v490_interpreter_validator_process_schema_repaired_reconciliation_outer.py"
...
R2_BYTES=51845
ATTEMPT_ROOT=J/"v496_v495_v490_interpreter_validator_process_schema_repaired_reconciliation_inner_attempt_seed1638_20260825"
ATTEMPT_PREP=ATTEMPT_ROOT.with_name(ATTEMPT_ROOT.name+".attempt-prep")
LOCK_PATH=J/".v496_v495_v490_interpreter_validator_process_schema_repaired_reconciliation_attempt.lock"
...
AUTHORITY_FORMAT="strict-track2-v496-v495-v490-interpreter-validator-process-schema-repair-execution-authority-v1"
AUTHORITY_STATUS="authorized_exact_one_external_v496_interpreter_validator_process_schema_repaired_outer_attempt"
AUTHORITY_CONTRACT_FORMAT="strict-track2-v496-v495-v490-interpreter-validator-process-schema-repair-execution-authority-design-contract-v1"
...
INTENT_FORMAT="strict-track2-v496-v495-v490-interpreter-validator-process-schema-repaired-reconciliation-inner-attempt-intent-v1"
TERMINAL_FORMAT="strict-track2-v496-v495-v490-interpreter-validator-process-schema-repaired-reconciliation-inner-attempt-terminal-v1"
...
def preflight(args)->dict:
 ...
 if outer_intent.get("format")!="strict-track2-v496-v495-v490-interpreter-validator-process-schema-repaired-reconciliation-outer-attempt-intent-v1" or outer_intent.get("status")!="committed_before_corrected_inner_start" or outer_intent.get("command_argv")!=expected_nested_argv or outer_intent.get("command_argv_sha256")!=csha(expected_nested_argv) or outer_intent.get("authority_receipt")!=authority_record:raise RuntimeError("outer intent crossbind")
...
def synthetic_self_test()->int:
 checks={
  ...
  "authority_top55_check45":len(AUTHORITY_TOP_KEYS)==55 and len(AUTHORITY_CHECK_KEYS)==45,
