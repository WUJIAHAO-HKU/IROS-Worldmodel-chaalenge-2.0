...
def main() -> None:
    ...
    parser.add_argument("--backend", choices=("synthetic", "ivideogpt", "residual-unet"), default="synthetic")
    parser.add_argument("--checkpoint-dir")
    parser.add_argument("--rounds", type=int, default=2)
    args = parser.parse_args()
    result = run_smoke(
        load_window_npz(args.window), build_backend(args.backend, args.checkpoint_dir), rounds=args.rounds
    )
    print(json.dumps({
