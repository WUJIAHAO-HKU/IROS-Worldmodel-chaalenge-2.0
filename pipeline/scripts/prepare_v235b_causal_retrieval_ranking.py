...
NAME = "v235b_public_causal_retrieval_ranking_seed1434_20260818"
...
SCRIPT = BASE / "pipeline/scripts/sweep_v235b_causal_retrieval_ranking.py"
...
def main() -> None:
    ...
    payload = {
        "format": "strict-track2-v235b-causal-retrieval-ranking-preregistration-v1",
        ...
        "retry_of": "v235_public_causal_retrieval_ranking_seed1434_20260818",
        "retry_reason": "pre-score alpha broadcasting shape error",
        "guards": {
