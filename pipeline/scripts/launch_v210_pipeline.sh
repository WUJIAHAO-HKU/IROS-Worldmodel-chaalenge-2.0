...
restart_v209() {
  bash "$P/restart_v209_services.sh" start > "$REG/restart_v209_after_pipeline.log" 2>&1 || true
}
...
export TRACK2_ACTOR_SEED=1408 TRACK2_ENV_SEED=0
...
for session in wm_v209_bridge wm_v209_gpu; do
...
echo V210_PUBLIC_POLICY_STAGE_B_PASSED
