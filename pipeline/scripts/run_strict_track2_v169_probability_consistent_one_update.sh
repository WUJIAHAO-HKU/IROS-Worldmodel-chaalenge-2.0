...
RUNTIME="$AUDIT/probability_consistent_one_update_v169_runtime"
RUN="$AUDIT/runs/probability_consistent_one_update_v169_seed1243"
...
SERVICE_DIR="$AUDIT/probability_consistent_service_v169"
BRIDGE_DIR="$AUDIT/probability_consistent_bridge_v169"
