#!/usr/bin/env python3
"""Deployment-batch causal and non-regression audit for v317."""
...
def main() -> int:
    ...
    baseline = Track2V271EndpointCalibratedTerminal(args.checkpoint_dir, args.library_index, args.device)
    candidate = Track2V317BatchedSparseFailureTerminal(args.checkpoint_dir, args.library_index, args.device, args.action_gate)
    ...
    checks = {
        ...
        "validation_positive_parent_terminal_numeric": parent_max["validation"] is not None and parent_max["validation"] <= 2,
        "local_test_positive_parent_terminal_numeric": parent_max["local_test"] is not None and parent_max["local_test"] <= 2,
    ...
    report = {
        "format": "strict-track2-v317-batched-sparse-failure-terminal-gate-v1",
        ...
        "authorization": {
            ...
            "right_terminal_ranking": checks["validation_pairwise_ranking"] and checks["local_test_pairwise_ranking"] and checks["validation_margin"] and checks["local_test_margin"],
