#!/usr/bin/env python3
"""Run the complete v334 causal gate against the v335 release alias."""
...
import audit_v334_bounded_onset_terminal_gate as inherited
...
def main() -> int:
    ...
    report["format"] = "strict-track2-v335-bounded-onset-terminal-gate-v1"
    report["candidate"] = "track2-v335-all-offset-bounded-onset-v334-v333-v326-v325-v317"
    report["inherited_audit"] = "strict-track2-v334-bounded-onset-terminal-gate-v1"
