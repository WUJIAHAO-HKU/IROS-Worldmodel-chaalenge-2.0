...
WRAPPER_PATH=ROOT/"pipeline/scripts/launch_v495_v494_v490_interpreter_validator_repaired_reconciliation_inner.py"
AUTHORITY_CONTRACT_PATH=ROOT/"pipeline/scripts/v495_v494_v490_interpreter_validator_repair_execution_authority_contract.json"
AUTHORITY_ROOT=J/"v495_v494_v490_interpreter_validator_repair_execution_authority_seed1637_20260825"
...
OUTER_WRAPPER_PATH=ROOT/"pipeline/scripts/launch_v495_v494_v490_interpreter_validator_repaired_reconciliation_outer.py"
OUTER_EVIDENCE_ROOT=J/"v495_v494_v490_interpreter_validator_repaired_reconciliation_outer_execution_evidence_seed1637_20260825"
...
R2_BYTES=51845
ATTEMPT_ROOT=J/"v495_v494_v490_interpreter_validator_repaired_reconciliation_inner_attempt_seed1637_20260825"
ATTEMPT_PREP=ATTEMPT_ROOT.with_name(ATTEMPT_ROOT.name+".attempt-prep")
LOCK_PATH=J/".v495_v494_v490_interpreter_validator_repaired_reconciliation_attempt.lock"
...
AUTHORITY_FORMAT="strict-track2-v495-v494-v490-interpreter-validator-repair-execution-authority-v1"
AUTHORITY_STATUS="authorized_exact_one_external_v495_interpreter_validator_repaired_outer_attempt"
AUTHORITY_CONTRACT_FORMAT="strict-track2-v495-v494-v490-interpreter-validator-repair-execution-authority-design-contract-v1"
...
AUTHORITY_KEYSET_SHA="b51330d741d0785fb4a499a9fe05e1310dd179875f402388007fdf76eb5ad4a5"
AUTHORITY_CHECKS_SHA="b22ffe54b87fd3e29a15987d0cafb5e8e51a3b0906bb1cc0aa89b33258f96bc3"
...
INTENT_FORMAT="strict-track2-v495-v494-v490-interpreter-validator-repaired-reconciliation-inner-attempt-intent-v1"
TERMINAL_FORMAT="strict-track2-v495-v494-v490-interpreter-validator-repaired-reconciliation-inner-attempt-terminal-v1"
...
def preflight(args)->dict:
 ...
 expected_sources={"v493_authority_contract":{"path":str(V493_AUTHORITY_CONTRACT_PATH),"sha256":V493_AUTHORITY_CONTRACT_SHA,"logical_bytes":V493_AUTHORITY_CONTRACT_BYTES},"v493_authority_materializer":{"path":str(V493_AUTHORITY_MATERIALIZER_PATH),"sha256":V493_AUTHORITY_MATERIALIZER_SHA,"logical_bytes":V493_AUTHORITY_MATERIALIZER_BYTES},"v493_outer_wrapper":{"path":str(V493_OUTER_WRAPPER_PATH),"sha256":V493_OUTER_WRAPPER_SHA,"logical_bytes":V493_OUTER_WRAPPER_BYTES},"v493_inner_wrapper":{"path":str(V493_INNER_WRAPPER_PATH),"sha256":V493_INNER_WRAPPER_SHA,"logical_bytes":V493_INNER_WRAPPER_BYTES},"v494_authority_contract":{"path":str(V494_AUTHORITY_CONTRACT_PATH),"sha256":V494_AUTHORITY_CONTRACT_SHA,"logical_bytes":V494_AUTHORITY_CONTRACT_BYTES},"v494_authority_materializer":{"path":str(V494_AUTHORITY_MATERIALIZER_PATH),"sha256":V494_AUTHORITY_MATERIALIZER_SHA,"logical_bytes":V494_AUTHORITY_MATERIALIZER_BYTES},"v494_outer_wrapper":{"path":str(V494_OUTER_WRAPPER_PATH),"sha256":V494_OUTER_WRAPPER_SHA,"logical_bytes":V494_OUTER_WRAPPER_BYTES},"v494_inner_wrapper":{"path":str(V494_INNER_WRAPPER_PATH),"sha256":V494_INNER_WRAPPER_SHA,"logical_bytes":V494_INNER_WRAPPER_BYTES},"corrected_inner_wrapper":wrapper_record,"outer_execution_wrapper":regular(OUTER_WRAPPER_PATH,observed_sources["outer_execution_wrapper"]["sha256"],observed_sources["outer_execution_wrapper"]["logical_bytes"]),"reconciler_r2":{"path":str(R2_PATH),"sha256":R2_SHA,"logical_bytes":R2_BYTES},"phase_a_design_contract":{"path":str(PHASE_A_DESIGN_CONTRACT_PATH),"sha256":PHASE_A_DESIGN_CONTRACT_SHA,"logical_bytes":PHASE_A_DESIGN_CONTRACT_BYTES},"v494_failure_forensic":{"path":str(V494_FAILURE_FORENSIC_PATH),"sha256":V494_FAILURE_FORENSIC_SHA,"logical_bytes":V494_FAILURE_FORENSIC_BYTES},"v494_failure_transport_script":{"path":str(V494_FAILURE_TRANSPORT_SCRIPT_PATH),"sha256":V494_FAILURE_TRANSPORT_SCRIPT_SHA,"logical_bytes":V494_FAILURE_TRANSPORT_SCRIPT_BYTES}}
 ...
 if outer_intent.get("format")!="strict-track2-v495-v494-v490-interpreter-validator-repaired-reconciliation-outer-attempt-intent-v1" or outer_intent.get("status")!="committed_before_corrected_inner_start" or outer_intent.get("command_argv")!=expected_nested_argv or outer_intent.get("command_argv_sha256")!=csha(expected_nested_argv) or outer_intent.get("authority_receipt")!=authority_record:raise RuntimeError("outer intent crossbind")
...
def synthetic_self_test()->int:
 checks={
  ...
  "authority_top47_check37":len(AUTHORITY_TOP_KEYS)==47 and len(AUTHORITY_CHECK_KEYS)==37,
