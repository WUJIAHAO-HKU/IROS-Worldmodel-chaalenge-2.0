#!/usr/bin/env python3
"""Run the frozen v326 terminal audit against v328 sequence semantics."""
...
def main() -> int:
    ...
    report["format"] = "strict-track2-v328-coherent-phase-trajectory-gate-v1"
    ...
    report["terminal_equivalence"] = (
        "v328 keeps v326 terminal semantics and changes only preterminal frames "
        "inside a phase-qualified coherent branch"
    )
    ...
    print(json.dumps({"v328_passed": report["passed"], "checks": checks}, indent=2))
