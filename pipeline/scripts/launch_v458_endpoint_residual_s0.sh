#!/usr/bin/env bash
# Preregistered public-train v458 WM parent gate only. No reward, policy update, RL, dev/final, or submission.
set -euo pipefail
ROOT='/root/autodl-tmp/IROS_WAM_2.0 challenge'
J="$ROOT/artifacts/strict_track2_joint_augmentation_20260810"
V461="$J/v461_endpoint200_seed1612_20260823"
REG="$J/v458_endpoint_residual_seed1611_20260823"
TRAINING="$REG/training"
RELEASE="$J/v458_v169_endpoint_residual_parent_release"
RLPY='/root/autodl-tmp/conda_envs/rlinf_track2/bin/python'
PREP="$ROOT/pipeline/scripts/prepare_v458_endpoint_residual_5fold.py"
TRAINER="$ROOT/pipeline/scripts/train_v458_endpoint_residual_5fold.py"
PACKAGER="$ROOT/pipeline/scripts/package_v458_endpoint_residual_release.py"
RUNTIME="$ROOT/pipeline/wam_pipeline/v458_v169_endpoint_residual_runtime.py"
...
LOCK_FILE='/var/lock/v458_endpoint_residual_seed1611.lock'
...
test "$(sha256sum "$PREP" | awk '{print $1}')" = '375cead1b830c21563138008e97eff3e94a35724589a3cb6e41b6a72971f7e96'
test "$(sha256sum "$TRAINER" | awk '{print $1}')" = '9536b5f1afd3b66c904b9ea58693809fb176ea7ef95ff2618e3ef3544fec91f8'
test "$(sha256sum "$PACKAGER" | awk '{print $1}')" = '9e8db6e45f9ebdee91878982c6fa4f91d1cf3e8dd81ef25d4db75243f25cb5ac'
test "$(sha256sum "$RUNTIME" | awk '{print $1}')" = '7059a665ac4fc0fe1571ab633e6a18a9ffe8fe10e6b274c883c7d0501bd84656'
...
payload={'format':'strict-track2-v458-launcher-failure-receipt-v1','passed':False,'reason':reason,'exit_code':int(code),'wall_seconds':int(elapsed),'gpu_peak_mib':int(peak),'training_process_group':int(pid) if pid else None,'reward_loaded':False,'policy_updates':0,'rl_authorized':False}
tmp=path+'.tmp'
...
WATCHDOG_PID=''
trap - EXIT TERM INT
echo V458_ENDPOINT_RESIDUAL_S0_AND_ALL200_COMPLETE
