...
from wam_pipeline.v409_half_contracted_progressive_runtime import (
...
def main() -> int:
    ...
    if payload.get("format") != "strict-track2-v409-half-contracted-progressive-preregistration-v1":
        raise RuntimeError("wrong v409 preregistration")
    ...
    sys.argv = argv
    base.Track2V385NativeBatchCleanReanchor = Track2V409HalfContractedProgressive
    try:
        code = base.main()
    finally:
        Path(temporary).unlink(missing_ok=True)
    report = json.loads(output.read_text())
    report["format"] = "strict-track2-v409-recursive-reward-causal-gate-v1"
