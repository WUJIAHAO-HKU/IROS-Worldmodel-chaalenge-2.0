...
PREREG="$ROOT/pipeline/config/strict_track2_v157_actor_offload_preregistration.json"
PREVIOUS_FAILURE="$ROOT/pipeline/config/strict_track2_v157_gpu_cache_release_result.json"
RUN_ROOT="$AUDIT_ROOT/runs/full_budget_actor_offload_v157_seed1238"
...
cp "$PREVIOUS_FAILURE" "$RUN_ROOT/audit/"
