#!/usr/bin/env python3
"""Exact-once Stage-A transport for the v535 public-S1 zero-update execution authority."""
...
SELF_PATH = SCRIPTS / "invoke_v536_v535_stage_a_contract_absence_schema_repair_authority_materializer_once.py"
SCRIPT_PATH = Path("/root/v536_v535_stage_a_contract_absence_schema_repair_authority_materialize_once.sh")
DEPLOYMENT_RECORD = SCRIPTS / "v536_v535_stage_a_contract_absence_schema_repair_authority_materialization_transport_deployment_record.json"
CONTRACT = SCRIPTS / "v535_v534_public_s1_zero_update_gate_execution_authority_contract.json"
CONTRACT_SHA = "a26ee76768f2b1260d502ed35030e1a35c26af8a5c0b20bb9926280c0ea62c52"
CONTRACT_BYTES = 140956
MATERIALIZER = SCRIPTS / "materialize_v535_v534_public_s1_zero_update_gate_execution_authority.py"
MATERIALIZER_SHA = "a99e5499dac6f18a540040ea99c7056097f742118e7cb5ec90a48acb30197101"
MATERIALIZER_BYTES = 28474
EVALUATOR = SCRIPTS / "evaluate_v535_v534_public_s1_zero_update_gate.py"
EVALUATOR_SHA = "8f95e503464725ab95c4caab4fef4552f1ed0aaedc6b2414dc578120fcaabd3c"
EVALUATOR_BYTES = 48432
AUDITOR = SCRIPTS / "audit_v535_v534_public_s1_zero_update_gate.py"
AUDITOR_SHA = "1a908135dd47e0a963b4356ec243f185a903940b8bfc992169abe71404e6f372"
AUDITOR_BYTES = 5186
LAUNCHER = SCRIPTS / "launch_v535_v534_public_s1_zero_update_gate.py"
LAUNCHER_SHA = "45297eadb144fc670c774d2319c74e246987ae8d5343f08bb149ada2bdfce017"
LAUNCHER_BYTES = 4270
PREREGISTRATION = SCRIPTS / "v535_v534_public_s1_zero_update_gate_preregistration.json"
PREREGISTRATION_SHA = "020b1e67b5d95286b6689cb00e564e66b5a0962908d8c3e1bad12d66abbc7106"
PREREGISTRATION_BYTES = 75267
MANIFEST = SCRIPTS / "v535_v534_public_s1_zero_update_gate_manifest.json"
MANIFEST_SHA = "a9876660419e58c883810ce5e8806d1fd5d008d56e7834521f17b0767f778ca4"
MANIFEST_BYTES = 77608
FORENSIC = SCRIPTS / "v536_v535_stage_a_contract_absence_schema_failure_forensic.json"
FORENSIC_SHA = "40d618dfae6cf9c5d47d65e0ce010e1d0893a160b96a8478755d750604cfd4b2"
FORENSIC_BYTES = 17807
OLD_HELPER = SCRIPTS / "invoke_v535_v534_public_s1_zero_update_gate_execution_authority_materializer_once.py"
OLD_HELPER_SHA = "153c52897fa9b1e3fb040610a20c9bb013c6ff90031a8400a8b3d12504fce973"
OLD_HELPER_BYTES = 75463
OLD_SCRIPT = Path("/root/v535_v534_public_s1_zero_update_gate_execution_authority_materialize_once.sh")
OLD_SCRIPT_SHA = "c05c0437999cfd498f728dd10dedd4300da79fdec57677987de23eddcbd9edb2"
OLD_SCRIPT_BYTES = 4163
OLD_RECORD = SCRIPTS / "v535_v534_public_s1_zero_update_gate_execution_authority_materialization_transport_deployment_record.json"
OLD_RECORD_SHA = "4ca1650f6e7f4f47c06cf630df9508b9b0179fa1908ba5c1d3616c4462f4db54"
OLD_RECORD_BYTES = 932
AUTHORITY_ROOT = J / "v535_v534_public_s1_zero_update_gate_execution_authority_seed1668_20260827"
AUTHORITY_PREP = AUTHORITY_ROOT.with_name(AUTHORITY_ROOT.name + ".authority-prep")
EVIDENCE_ROOT = J / "v536_v535_stage_a_contract_absence_schema_repair_authority_materialization_evidence_seed1668_20260827"
...
FROZEN_FINAL7_SHA256 = (CONTRACT_SHA, MATERIALIZER_SHA, PREREGISTRATION_SHA, MANIFEST_SHA,
                       EVALUATOR_SHA, AUDITOR_SHA, LAUNCHER_SHA)
...
EXPECTED_CURRENT_ABSENCE_PATHS = {
    "attempt_prep": "/root/autodl-tmp/IROS_WAM_2.0 challenge/artifacts/strict_track2_joint_augmentation_20260810/v535_v534_public_s1_zero_update_gate_attempt_seed1668_20260827.attempt-prep",
    "attempt_root": "/root/autodl-tmp/IROS_WAM_2.0 challenge/artifacts/strict_track2_joint_augmentation_20260810/v535_v534_public_s1_zero_update_gate_attempt_seed1668_20260827",
    "authority_prep": "/root/autodl-tmp/IROS_WAM_2.0 challenge/artifacts/strict_track2_joint_augmentation_20260810/v535_v534_public_s1_zero_update_gate_execution_authority_seed1668_20260827.authority-prep",
    "output_prep": "/root/v535_v534_public_s1_zero_update_gate_seed1668_20260827.output-prep",
    "output_root": "/root/v535_v534_public_s1_zero_update_gate_seed1668_20260827",
}
EXPECTED_CURRENT_ABSENCE_MAP_SHA256 = "a3982c96653ee167788878e4c523674d98ab6bcce5c53aa48cf52893d40388b3"
...
def deployment_plan() -> dict:
    ...
    old_transport3 = [
        {"role": "failed_v535_transport_helper", "path": str(OLD_HELPER), "sha256": OLD_HELPER_SHA, "logical_bytes": OLD_HELPER_BYTES},
        {"role": "failed_v535_transport_script", "path": str(OLD_SCRIPT), "sha256": OLD_SCRIPT_SHA, "logical_bytes": OLD_SCRIPT_BYTES},
        {"role": "failed_v535_transport_record", "path": str(OLD_RECORD), "sha256": OLD_RECORD_SHA, "logical_bytes": OLD_RECORD_BYTES},
    ]
    forensic = {"role": "v535_absence_schema_failure_forensic", "path": str(FORENSIC), "sha256": FORENSIC_SHA, "logical_bytes": FORENSIC_BYTES}
    return {
        "reused_current_only_exact10": final7 + old_transport3,
        "fresh_failure_forensic_noreplace_exact1": forensic,
        "fresh_failure_forensic_volatile_source": {**forensic, "source_path": "/dev/shm/" + FORENSIC.name},
        "fresh_noncyclic_transport_triple_external_noreplace_required": True,
        "old_failed_transport_invocations": 1,
...
def validate_failure_forensic() -> dict:
    ...
    expected_top = ["captured_at_date", "classification", "format", "fresh_repair_boundary",
                    "fresh_roots_current", "invocation_partition", "readonly_post_failure_closure",
                    "root_cause", "status", "v535_final10_deployment", "v535_transport_selftest",
                    "v535_unique_normal_failure"]
    boundary = value.get("fresh_repair_boundary", {})
    partition = value.get("invocation_partition", {})
    root_cause = value.get("root_cause", {})
    normal = value.get("v535_unique_normal_failure", {})
    if (list(value) != expected_top
            or value.get("format") != "strict-track2-v536-v535-stage-a-contract-absence-schema-failure-forensic-v1"
            or value.get("status") != "frozen_failed_no_retry_pending_fresh_versioned_transport_schema_repair"
            or boundary.get("fresh_versioned_transport_helper_required") is not True
            or boundary.get("fresh_versioned_transport_script_required") is not True
            or boundary.get("fresh_noncyclic_transport_deployment_record_required") is not True
            or boundary.get("old_transport_overwrite_authorized") is not False
            or boundary.get("old_transport_retry_authorized") is not False
            or boundary.get("successor_row_keyset_exact") != ["absent", "path"]
            or boundary.get("successor_absent_value_must_be_strict_true") is not True
            or boundary.get("successor_paths_must_bijectively_equal_expected_absence_map") is not True
            or boundary.get("successor_expected_absence_map_canonical_sha256_crossbind_required") is not True
            or type(partition.get("transport_helper_normal_entries_observed_non_durable")) is not int
            or partition.get("transport_helper_normal_entries_observed_non_durable") != 1
            or type(partition.get("transport_helper_popen_invocations")) is not int
            or partition.get("transport_helper_popen_invocations") != 0
            or type(partition.get("authority_materializer_invocations")) is not int
            or partition.get("authority_materializer_invocations") != 0
            or cbytes(root_cause.get("contract_current_absences_after_authority_exact"))
               != cbytes({key: {"absent": True, "path": EXPECTED_CURRENT_ABSENCE_PATHS[key]}
                          for key in EXPECTED_CURRENT_ABSENCE_KEYS})
            or root_cause.get("contract_current_absence_keyset_exact") != EXPECTED_CURRENT_ABSENCE_KEYS
            or root_cause.get("sole_failed_predicate") is not True
            or root_cause.get("failure_before_popen") is not True
            or normal.get("retry_performed") is not False
            or normal.get("cleanup_performed") is not False
            or normal.get("tool_capture", {}).get("numeric_returncode") != 1
            or normal.get("tool_capture", {}).get("combined_output_sha256")
               != "cba24619603da91819e10c19649489fa0ee4c4d0c4858f31a4e95544526baba2"):
        raise RuntimeError("v536 failure forensic exact")
...
def expected_transport_deployment(helper_record: dict, script_record: dict) -> dict:
    return {
        "format": "strict-track2-v536-stage-a-transport-pair-deployment-record-v1",
...
def immutable_snapshot(contract: dict, helper_record: dict, script_record: dict) -> dict:
    ...
    return {
        ...
        "v535_failure_forensic": validate_failure_forensic(),
        "failed_v535_transport_helper": regular(OLD_HELPER, (OLD_HELPER_SHA, OLD_HELPER_BYTES)),
        "failed_v535_transport_script": regular(OLD_SCRIPT, (OLD_SCRIPT_SHA, OLD_SCRIPT_BYTES)),
        "failed_v535_transport_record": regular(OLD_RECORD, (OLD_RECORD_SHA, OLD_RECORD_BYTES)),
...
def validate_materializer_contract(module, contract: dict, materializer_record: dict) -> None:
    ...
    schema_checks = {
        ...
        "seed": type(seed) is int and seed == 1668,
        ...
        "authority_top_count": len(contract.get("authority_receipt_contract", {}).get("top_keys", [])) == 62,
        "check_count": len(module.CHECK_KEYS) == 31,
        "source_counts": len(module.SOURCE_ROLES) == 30 and len(module.AUTHORITY_SOURCE_ROLES) == 31,
...
def load_materializer(contract_source: Path = CONTRACT, materializer_source: Path = MATERIALIZER,
    ...
    spec = importlib.util.spec_from_file_location("v535_materializer", materializer_source)
    ...
    try:
        ...
        lines = [
            ...
            {"line_origin": "transport_helper", "passed": True,
              ...
              "failed_v535_transport_helper_normal_entries_non_durable": 1,
              "failed_v535_transport_helper_popen_invocations": 0,
...
def validate_success(module, contract: dict, returncode: int, cleanup: dict,
    ...
    if (os.path.lexists(AUTHORITY_PREP)
            or sorted(receipt) != receipt_schema["top_keys"] or len(receipt) != 62
            ...
            or len(receipt.get("source_closure", {})) != 31
...
def base_receipt(status: str, passed: bool, invocations: int, cleanup: dict, error: BaseException | None = None) -> dict:
    row = {
        "format": "strict-track2-v536-v535-stage-a-contract-absence-schema-repair-authority-materializer-process-receipt-v1",
...
def orchestrate(*, root: Path, prep: Path, child_argv: list[str], helper_source: Path,
    ...
    try:
        ...
        write_exclusive(prep / "intent.json", cbytes({
            "format": "strict-track2-v536-v535-stage-a-contract-absence-schema-repair-authority-materializer-intent-v1",
...
def production_fixture(contract_source: Path = CONTRACT, materializer_source: Path = MATERIALIZER,
    ...
    checks = {
        ...
        "old_final10_current_fresh_forensic_transport3": (
            len(plan["reused_current_only_exact10"]) == 10
            and plan["fresh_failure_forensic_noreplace_exact1"]
                == {"role": "v535_absence_schema_failure_forensic", "path": str(FORENSIC),
                    "sha256": FORENSIC_SHA, "logical_bytes": FORENSIC_BYTES}
            and plan["fresh_noncyclic_transport_triple_external_noreplace_required"] is True
            and plan["old_failed_transport_invocations"] == 1
        ...
        "authority_schema_62_31_31": (
            len(contract["authority_receipt_contract"]["top_keys"]) == 62
            and len(module.CHECK_KEYS) == 31 and len(module.AUTHORITY_SOURCE_ROLES) == 31),
    ...
    with tempfile.TemporaryDirectory(prefix="v536-stage-a-helper-", dir="/dev/shm") as folder:
        temp = Path(folder)
        ...
        result = orchestrate(
            ...
            argv_payload={"format": "synthetic-v536-stage-a", "pre_snapshot": pre,
                          "transport_deployment_record": deployment_record,
...
def main() -> int:
    ...
    argv = command()
    payload = {
        "format": "strict-track2-v536-v535-stage-a-contract-absence-schema-repair-authority-materializer-argv-v1",
