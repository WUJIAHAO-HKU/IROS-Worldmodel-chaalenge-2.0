#!/usr/bin/env python3
"""Exact-once Stage-A transport for the v542 runtime-package-repair training authority."""
...
SELF_PATH = SCRIPTS / "invoke_v542_v541_fixed_budget_all200_training_runtime_package_repair_execution_authority_materializer_once.py"
SCRIPT_PATH = Path("/root/v542_v541_fixed_budget_all200_training_runtime_package_repair_execution_authority_materialize_once.sh")
DEPLOYMENT_RECORD = SCRIPTS / "v542_v541_fixed_budget_all200_training_runtime_package_repair_execution_authority_materialization_transport_deployment_record.json"
CONTRACT = SCRIPTS / "v542_v541_fixed_budget_all200_training_runtime_package_repair_execution_authority_contract.json"
CONTRACT_SHA = "d918c23b84c03d35e71ff4c9a388598d4a586150e5c5ff4bf68ef55d3fca1ad0"
CONTRACT_BYTES = 48038
MATERIALIZER = SCRIPTS / "materialize_v542_v541_fixed_budget_all200_training_runtime_package_repair_execution_authority.py"
MATERIALIZER_SHA = "f0e8a656a3e7c078eb13bc3f1e99f1da965bf13d2594cf83769f507b7146c62c"
MATERIALIZER_BYTES = 16598
TRAINER = SCRIPTS / "train_v542_v541_fixed_budget_all200_runtime_package_repair.py"
TRAINER_SHA = "c572d6ed9843e128f8b191c1a28c93ad8762aa5f0c87a7c25327b7a4a33c8cee"
TRAINER_BYTES = 52003
AUDITOR = SCRIPTS / "audit_v542_v541_fixed_budget_all200_runtime_package_repair.py"
AUDITOR_SHA = "926053bbed29f403b625e4940cf61ced05701430302ac4b17f820f217b058c0b"
AUDITOR_BYTES = 4784
LAUNCHER = SCRIPTS / "launch_v542_v541_fixed_budget_all200_runtime_package_repair.py"
LAUNCHER_SHA = "e8917e5f4361bda438bac3c9697ca7dea7415e616b26f59c5391dcc2e0f12b2a"
LAUNCHER_BYTES = 2720
PREREGISTRATION = SCRIPTS / "v542_v541_fixed_budget_all200_training_runtime_package_repair_preregistration.json"
PREREGISTRATION_SHA = "4b2880d743f45ad33dd25421e147641d3a15085a6a5adcaac1cd16962caa833b"
PREREGISTRATION_BYTES = 5997
MANIFEST = SCRIPTS / "v542_v541_fixed_budget_all200_training_runtime_package_repair_manifest.json"
MANIFEST_SHA = "911c5fcccedd88101f2b07541e4b37b49e5f30766b5a43652b5fb5642a096146"
MANIFEST_BYTES = 6658
FORENSIC = SCRIPTS / "v542_v541_fixed_budget_training_runtime_package_import_failure_forensic.json"
FORENSIC_SHA = "58e0067017de098441531227309ca39bc5150aab63a862bb397b12dd4e891a2e"
FORENSIC_BYTES = 5383
...
AUTHORITY_ROOT = J / "v542_v541_fixed_budget_all200_training_runtime_package_repair_execution_authority_seed1673_20260828"
AUTHORITY_PREP = AUTHORITY_ROOT.with_name(AUTHORITY_ROOT.name + ".authority-prep")
EVIDENCE_ROOT = J / "v542_v541_fixed_budget_all200_training_runtime_package_repair_execution_authority_materialization_evidence_seed1673_20260828"
...
FROZEN_FINAL8_SHA256 = (CONTRACT_SHA, MATERIALIZER_SHA, PREREGISTRATION_SHA, MANIFEST_SHA,
                       TRAINER_SHA, AUDITOR_SHA, LAUNCHER_SHA, FORENSIC_SHA)
...
EXPECTED_CURRENT_ABSENCE_PATHS = {
    "attempt_prep": "/root/autodl-tmp/IROS_WAM_2.0 challenge/artifacts/strict_track2_joint_augmentation_20260810/v542_v541_fixed_budget_all200_training_runtime_package_repair_attempt_seed1673_20260828.attempt-prep",
    "attempt_root": "/root/autodl-tmp/IROS_WAM_2.0 challenge/artifacts/strict_track2_joint_augmentation_20260810/v542_v541_fixed_budget_all200_training_runtime_package_repair_attempt_seed1673_20260828",
    "authority_prep": "/root/autodl-tmp/IROS_WAM_2.0 challenge/artifacts/strict_track2_joint_augmentation_20260810/v542_v541_fixed_budget_all200_training_runtime_package_repair_execution_authority_seed1673_20260828.authority-prep",
    "output_prep": "/root/v542_v541_fixed_budget_all200_training_runtime_package_repair_seed1624_20260828.training-prep",
    "output_root": "/root/v542_v541_fixed_budget_all200_training_runtime_package_repair_seed1624_20260828",
}
EXPECTED_CURRENT_ABSENCE_MAP_SHA256 = "0ce0734d67d539c7a76854e9691001b18a723381dcfb756d126198fa7041ff20"
...
def deployment_plan() -> dict:
    final8 = [
        ...
        {"role": "fixed_budget_training_preregistration", "path": str(PREREGISTRATION), "sha256": PREREGISTRATION_SHA, "logical_bytes": PREREGISTRATION_BYTES},
        {"role": "fixed_budget_training_manifest", "path": str(MANIFEST), "sha256": MANIFEST_SHA, "logical_bytes": MANIFEST_BYTES},
        {"role": "fixed_budget_trainer", "path": str(TRAINER), "sha256": TRAINER_SHA, "logical_bytes": TRAINER_BYTES},
        {"role": "fixed_budget_training_independent_auditor", "path": str(AUDITOR), "sha256": AUDITOR_SHA, "logical_bytes": AUDITOR_BYTES},
        {"role": "fixed_budget_training_launcher", "path": str(LAUNCHER), "sha256": LAUNCHER_SHA, "logical_bytes": LAUNCHER_BYTES},
        {"role": "v541_failure_forensic_data_only", "path": str(FORENSIC), "sha256": FORENSIC_SHA, "logical_bytes": FORENSIC_BYTES,
         "required_mode": "0600", "nonexecutable": True, "invocations_authorized": 0},
    ]
    return {
...
def expected_transport_deployment(helper_record: dict, script_record: dict) -> dict:
    return {
        "format": "strict-track2-v542-stage-a-transport-pair-deployment-record-v1",
...
def forbidden_entrypoints() -> set[str]:
    return {
        str(LAUNCHER), str(TRAINER), str(AUDITOR),
...
def validate_materializer_contract(module, contract: dict, materializer_record: dict) -> None:
    ...
    trainer_source = Path(getattr(module, "TRAINER", TRAINER))
    trainer_spec = importlib.util.spec_from_file_location("v542_stage_a_trainer_schema", trainer_source)
    ...
    active = {
        ...
        "fixed_budget_training_preregistration": {"path": str(PREREGISTRATION), "sha256": PREREGISTRATION_SHA, "logical_bytes": PREREGISTRATION_BYTES},
        "fixed_budget_training_manifest": {"path": str(MANIFEST), "sha256": MANIFEST_SHA, "logical_bytes": MANIFEST_BYTES},
        "fixed_budget_trainer": {"path": str(TRAINER), "sha256": TRAINER_SHA, "logical_bytes": TRAINER_BYTES},
        "fixed_budget_training_independent_auditor": {"path": str(AUDITOR), "sha256": AUDITOR_SHA, "logical_bytes": AUDITOR_BYTES},
        "fixed_budget_training_launcher": {"path": str(LAUNCHER), "sha256": LAUNCHER_SHA, "logical_bytes": LAUNCHER_BYTES},
    }
    schema_checks = {
        "contract_path": module.CONTRACT == CONTRACT,
        "authority_root": module.AUTH_ROOT == AUTHORITY_ROOT,
        "contract_top": set(contract) == trainer_module.CONTRACT_KEYS,
        "format": contract.get("format") == "strict-track2-v542-v541-fixed-budget-all200-training-execution-authority-design-contract-v1",
        "status": contract.get("status") == "design_only_frozen_fixed_budget_training_sources_pending_independent_authority_materialization",
        "seed": type(seed) is int and seed == 1673,
        ...
        "active_role_order": contract.get("active_source_role_order") == trainer_module.ACTIVE_ROLE_ORDER,
        "active_paths": contract.get("active_source_paths") == trainer_module.ACTIVE_PATHS,
        "contract_active_records_exact6": contract.get("active_source_records") == active,
        "authority_top_count": len(contract.get("authority_receipt_contract", {}).get("top_keys", [])) == 63,
        "check_count": len(trainer_module.CHECK_KEYS) == 34,
        "source_counts": len(trainer_module.SOURCE_ROLE_ORDER) == 32 and len(trainer_module.AUTHORITY_SOURCE_ALIASES) == 33,
        "source_order": contract.get("source_role_order") == trainer_module.SOURCE_ROLE_ORDER,
        "source_aliases": contract.get("source_aliases") == trainer_module.SOURCE_ALIASES,
        "v540_gate_and_v534_sources_current": (
            contract.get("v540_gate_transition", {}).get("exact_count") == 8
            and contract.get("v540_gate_transition", {}).get("passed_ancestry_only") is True
            and contract.get("v540_gate_transition", {}).get("metrics_semantic_parse_authorized") is False
            and contract.get("v540_gate_transition", {}).get("config_or_budget_selected_from_v540_metrics") is False
            and contract.get("v540_gate_transition", {}).get("retry_authorized") is False
            and all(role in contract.get("source_closure", {}) for role in (
                "v534_authority_receipt", "v534_actual_oof_execution_receipt",
                "v534_actual_oof_independent_audit", "v534_actual_oof_source_manifest"))),
        "lineage_exact": cbytes(contract.get("lineage")) == cbytes(trainer_module.EXPECTED_LINEAGE),
        "fixed_budget_contracts": (
            cbytes(contract.get("budget_contract")) == cbytes(read_json_exact(PREREGISTRATION, PREREGISTRATION_SHA, PREREGISTRATION_BYTES).get("budget_contract"))
            and contract.get("authorization", {}).get("optimizer_step_invocations_authorized") == 500
            and contract.get("authorization", {}).get("fixed_budget_training_boundary_invocations_consumed") == 0
            and contract.get("authorization", {}).get("hidden_private_or_final_input_authorized") is False),
    }
    if not all(schema_checks.values()):
        raise RuntimeError("materializer/contract schema " + json.dumps(schema_checks, sort_keys=True))
    if (cbytes(contract.get("authorization")) != cbytes(trainer_module.EXPECTED_AUTHORIZATION)
            or csha(contract.get("runtime_observation")) != csha(trainer_module.EXPECTED_RUNTIME_OBSERVATION)
            or csha(contract.get("execution_boundary")) != csha(trainer_module.EXPECTED_EXECUTION_BOUNDARY)):
        raise RuntimeError("v542 fixed-budget training runtime-package-repair authority boundary")
    for role, row in contract["source_closure"].items():
    ...
    try:
        ...
        helper_line = {"line_origin": "transport_helper", "passed": True,
              ...
              "actual_oof_execution_invocations": 0,
               "v541_failed_training_transport_entries_non_durable": 1,
               "v541_failed_training_transport_materializer_invocations": 0,
               "v541_failure_forensic_invocations": 0,
...
def validate_success(module, contract: dict, returncode: int, cleanup: dict,
    ...
    trainer_source = Path(getattr(module, "TRAINER", TRAINER))
    trainer_spec = importlib.util.spec_from_file_location("v541_stage_a_success_trainer_schema", trainer_source)
    trainer_module = importlib.util.module_from_spec(trainer_spec); trainer_spec.loader.exec_module(trainer_module)
    ...
    if (os.path.lexists(AUTHORITY_PREP)
            or sorted(receipt) != receipt_schema["top_keys"] or len(receipt) != 63
            or receipt.get("format") != module.OUTPUT_FORMAT
            or receipt.get("status") != module.OUTPUT_STATUS or receipt.get("passed") is not True
            or len(receipt.get("checks", {})) != 34
            or set(receipt.get("checks", {})) != set(trainer_module.CHECK_KEYS)
            or not all(type(value) is bool and value is True for value in receipt["checks"].values())
            or receipt.get("check_key_set_sha256") != csha(trainer_module.CHECK_KEYS)
            or receipt.get("checks_sha256") != csha(receipt["checks"])
            or len(receipt.get("source_closure", {})) != 33
            or receipt.get("source_role_order") != ["authority_design_contract", *trainer_module.SOURCE_ROLE_ORDER]
            or receipt.get("source_aliases") != trainer_module.AUTHORITY_SOURCE_ALIASES
            or receipt.get("active_source_role_order") != trainer_module.ACTIVE_ROLE_ORDER
            or receipt.get("active_source_paths") != trainer_module.ACTIVE_PATHS
            or not isinstance(authority_active_records, dict)
            or set(authority_active_records) != set(trainer_module.ACTIVE_ROLE_ORDER)
            or any(authority_active_records.get(role) != receipt.get("source_closure", {}).get(role)
                   for role in trainer_module.ACTIVE_ROLE_ORDER)
            or receipt_schema.get("active_source_role_order_exact") != trainer_module.ACTIVE_ROLE_ORDER
            or receipt_schema.get("active_source_paths_exact") != trainer_module.ACTIVE_PATHS
            ...
            or cbytes(receipt.get("authorization")) != cbytes(trainer_module.EXPECTED_AUTHORIZATION)
            or cbytes(receipt.get("runtime_observation")) != cbytes(trainer_module.EXPECTED_RUNTIME_OBSERVATION)
            or cbytes(receipt.get("execution_boundary")) != cbytes(trainer_module.EXPECTED_EXECUTION_BOUNDARY)
            or receipt.get("source_closure_sha256") != csha(receipt.get("source_closure"))
            or any(cbytes(receipt.get(key)) != cbytes(contract[key]) for key in ("budget_contract","authorization","base_training_contract","output_contract","v540_gate_transition"))
    ...
    if receipt.get("source_aliases") != trainer_module.AUTHORITY_SOURCE_ALIASES: raise RuntimeError("authority source aliases")
    for role, alias in trainer_module.AUTHORITY_SOURCE_ALIASES.items():
        if receipt.get(alias) != receipt.get("source_closure", {}).get(role): raise RuntimeError("authority source alias:"+role)
    authorization = receipt.get("authorization", {})
    if (type(authorization.get("fixed_budget_training_boundary_invocations_authorized")) is not int
            or authorization.get("fixed_budget_training_boundary_invocations_authorized") != 1
            or type(authorization.get("fixed_budget_training_boundary_invocations_consumed")) is not int
            or authorization.get("fixed_budget_training_boundary_invocations_consumed") != 0
            or type(authorization.get("optimizer_step_invocations_authorized")) is not int
            or authorization.get("optimizer_step_invocations_authorized") != 500
        ...
        raise RuntimeError("fixed-budget training authority partition")
    gate = receipt.get("v540_gate_transition", {})
    if (gate.get("exact_count") != 8 or gate.get("passed_ancestry_only") is not True
            or gate.get("metrics_semantic_parse_authorized") is not False
            or gate.get("config_or_budget_selected_from_v540_metrics") is not False
            or gate.get("retry_authorized") is not False):
        raise RuntimeError("v540 public-S1 zero-update transition")
    ...
    return {"authority_receipt": receipt_record, "authority_registration_tree": tree,
            ...
            "v540_public_s1_zero_update_gate_durable_boundary_invocations": 1}


def base_receipt(status: str, passed: bool, invocations: int, cleanup: dict, error: BaseException | None = None) -> dict:
    row = {
        "format": "strict-track2-v542-v541-fixed-budget-all200-training-runtime-package-repair-authority-materializer-process-receipt-v1",
        "status": status, "passed": passed, "authority_materializer_invocations": invocations,
        "transport_helper_invocations": 1,
        "fixed_budget_training_boundary_invocations": 0,
        "training_launcher_invocations": 0, "training_trainer_invocations": 0,
        "training_independent_auditor_invocations": 0,
        "optimizer_step_invocations": 0, "final_checkpoint_writes": 0,
        "training_output_publication_invocations": 0,
        "posttrain_public_s1_evaluator_invocations": 0,
        "v541_failure_forensic_invocations": 0,
        "v541_failed_training_transport_retry_invocations": 0,
        "v534_actual_oof_durable_boundary_invocations": 1,
        "actual_oof_execution_invocations": 0,
...
def orchestrate(*, root: Path, prep: Path, child_argv: list[str], helper_source: Path,
    ...
    try:
        ...
        write_exclusive(prep / "intent.json", cbytes({
            "format": "strict-track2-v542-v541-fixed-budget-all200-training-runtime-package-repair-authority-materializer-intent-v1",
        ...
        receipt = {
            **base_receipt("passed_exact_once_fixed_budget_training_authority_materialized_no_training_execution", True, 1, cleanup),
...
def production_fixture(contract_source: Path = CONTRACT, materializer_source: Path = MATERIALIZER,
    ...
    checks = {
        ...
        "fresh_final8_transport3_deploy11": (
            ...
            and plan["fresh_final8_noreplace"][-1]["role"] == "v541_failure_forensic_data_only"
            and plan["fresh_final8_noreplace"][-1]["required_mode"] == "0600"
            and plan["fresh_final8_noreplace"][-1]["nonexecutable"] is True
            and plan["fresh_final8_noreplace"][-1]["invocations_authorized"] == 0
        ...
        "authority_schema_63_34_33": (
            len(contract["authority_receipt_contract"]["top_keys"]) == 63),
        "fixed_budget_authorization_exact": (
            contract["authorization"]["fixed_budget_training_boundary_invocations_authorized"] == 1
            and contract["authorization"]["fixed_budget_training_boundary_invocations_consumed"] == 0
            and contract["authorization"]["optimizer_step_invocations_authorized"] == 500
            and contract["authorization"]["training_authorized"] is True
            and contract["authorization"]["hidden_private_or_final_input_authorized"] is False),
        "downstream_not_in_child_argv": (
            all(str(path) not in command() for path in (TRAINER, AUDITOR, LAUNCHER, FORENSIC))
            and not any("launch_" in item or "train_" in item or "audit_" in item for item in command())),
    ...
    with tempfile.TemporaryDirectory(prefix="v542-stage-a-helper-", dir="/dev/shm") as folder:
        temp = Path(folder)
        ...
        result = orchestrate(
            ...
            argv_payload={"format": "synthetic-v542-stage-a", "pre_snapshot": pre,
                          "transport_deployment_record": deployment_record,
        ...
        checks["mapped_normal_exact6"] = (
            ...
            and result["process_receipt"]["fixed_budget_training_boundary_invocations"] == 0)
    ...
    return {"passed": True, "checks": checks, "checks_sha256": csha(checks),
            "materializer_invocations": 0, "fixed_budget_training_boundary_invocations": 0,
            "training_trainer_invocations": 0, "auditor_invocations": 0, "launcher_invocations": 0,
...
def main() -> int:
    ...
    argv = command()
    payload = {
        "format": "strict-track2-v542-v541-fixed-budget-all200-training-runtime-package-repair-authority-materializer-argv-v1",
