...
def main() -> int:
    ...
    if payload.get("format") != "strict-track2-v407-one-chunk-progressive-preregistration-v1":
        raise RuntimeError("wrong v407 preregistration")
    ...
    sys.argv = argv
    base.Track2V385NativeBatchCleanReanchor = Track2V407OneChunkProgressive
    try:
        code = base.main()
    finally:
        Path(temporary).unlink(missing_ok=True)
    report = json.loads(output.read_text())
    report["format"] = "strict-track2-v407-recursive-reward-causal-gate-v1"
