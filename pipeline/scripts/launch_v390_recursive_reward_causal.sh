...
RUN="$J/v390_continuous_phase_clean_reanchor_seed1551_20260823"
...
taskset -c 0-11 "$PY" "$ROOT/pipeline/scripts/audit_v390_recursive_reward_causal.py" \
...
echo V390_RECURSIVE_FIDELITY_COMPLETE
