...
RUN="$J/v406_progressive_then_terminal_seed1564_20260823"
REG="$O/run_registry/v406_progressive_then_terminal_seed1564_20260823"
...
set +e
taskset -c 0-11 "$PY" "$ROOT/pipeline/scripts/audit_v406_recursive_reward_causal.py" \
...
echo "V406_RECURSIVE_AUDIT_EXIT=$status"
exit "$status"
