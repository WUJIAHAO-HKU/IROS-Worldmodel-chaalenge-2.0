...
RUN="$J/v408_temporal_ramp_progressive_seed1566_20260823"
REG="$O/run_registry/v408_temporal_ramp_progressive_seed1566_20260823"
...
set +e
taskset -c 0-11 "$PY" "$ROOT/pipeline/scripts/audit_v408_recursive_reward_causal.py" \
...
echo "V408_RECURSIVE_AUDIT_EXIT=$status"
exit "$status"
