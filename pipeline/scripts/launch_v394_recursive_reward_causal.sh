...
RUN="$J/v394_failure_calibrated_clean_reanchor_seed1555_20260823"
...
taskset -c 0-15 "$PY" "$ROOT/pipeline/scripts/audit_v394_failure_calibrated_clean_reanchor.py" \
...
echo V394_RECURSIVE_FIDELITY_COMPLETE
