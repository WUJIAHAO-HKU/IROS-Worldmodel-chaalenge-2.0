...
WRAPPER_PATH=ROOT/"pipeline/scripts/launch_v493_v492_v490_corrected_reconciliation_inner.py"
AUTHORITY_CONTRACT_PATH=ROOT/"pipeline/scripts/v493_v492_v490_corrected_reconciliation_execution_authority_contract.json"
...
V492_AUTHORITY_CONTRACT_PATH=ROOT/"pipeline/scripts/v492_v491_v490_reconciliation_execution_authority_contract.json"
V492_AUTHORITY_CONTRACT_SHA="32adf6dcfed2e8e9d4e500eec4d55847fe304b8f96633763a85f90017f1fb07b"
V492_AUTHORITY_CONTRACT_BYTES=25772
V492_AUTHORITY_MATERIALIZER_PATH=ROOT/"pipeline/scripts/materialize_v492_v491_v490_reconciliation_execution_authority.py"
V492_AUTHORITY_MATERIALIZER_SHA="dc9ebcc9d24f3b327cda3f0730fb5d8528f2d38b95d0f54c001a057174b0e532"
V492_AUTHORITY_MATERIALIZER_BYTES=38380
V492_OUTER_WRAPPER_PATH=ROOT/"pipeline/scripts/launch_v492_v491_v490_reconciliation_via_v490_wrapper.py"
V492_OUTER_WRAPPER_SHA="bd212226de02eb646ed6cfb41dac5f504a954de8b7f2862fef85e9ee4a05895b"
V492_OUTER_WRAPPER_BYTES=43036
SUPERSEDED_V490_INNER_PATH=ROOT/"pipeline/scripts/launch_v490_v489_v488_v487_c71_exact7_schema_repair.py"
SUPERSEDED_V490_INNER_SHA="733931fa162c7e2559fcbf45b7ce8b98960db61df958143c7df3f4c15f3bc877"
SUPERSEDED_V490_INNER_BYTES=67698
V492_AUTHORITY_ROOT=J/"v492_v491_v490_reconciliation_execution_authority_seed1634_20260825"
V492_AUTHORITY_RECEIPT_PATH=V492_AUTHORITY_ROOT/"authority_receipt.json"
V492_AUTHORITY_RECEIPT_SHA="a0be9be3de912188cb7654b07fb2177bb9b79008c4558805147efb79c5e443b2"
V492_AUTHORITY_RECEIPT_BYTES=59593
V492_AUTHORITY_MATERIALIZATION_EVIDENCE_ROOT=J/"v492_v491_v490_reconciliation_execution_authority_materialization_evidence_seed1634_20260825"
V492_OUTER_FAILURE_ROOT=J/"v492_v491_v490_reconciliation_outer_execution_evidence_seed1634_20260825"
OUTER_WRAPPER_PATH=ROOT/"pipeline/scripts/launch_v493_v492_v490_corrected_reconciliation_outer.py"
...
R2_BYTES=51845
ATTEMPT_ROOT=J/"v493_v492_v490_corrected_reconciliation_inner_attempt_seed1635_20260825"
ATTEMPT_PREP=ATTEMPT_ROOT.with_name(ATTEMPT_ROOT.name+".attempt-prep")
LOCK_PATH=J/".v493_v492_v490_corrected_reconciliation_attempt.lock"
...
AUTHORITY_FORMAT="strict-track2-v493-v492-v490-corrected-reconciliation-execution-authority-v1"
AUTHORITY_STATUS="authorized_exact_one_external_v493_corrected_reconciliation_outer_attempt"
AUTHORITY_CONTRACT_FORMAT="strict-track2-v493-v492-v490-corrected-reconciliation-execution-authority-design-contract-v1"
...
AUTHORITY_KEYSET_SHA="55b257b1d6837b0b6240361a7a233526b17dd006e8534314ab5689dba6f5ae6f"
AUTHORITY_CHECKS_SHA="cd1cda09f441f917823c33102aaaf02b0580d14d8bb2f356c3dd574afa92dae4"
...
INTENT_FORMAT="strict-track2-v493-v492-v490-corrected-reconciliation-inner-attempt-intent-v1"
TERMINAL_FORMAT="strict-track2-v493-v492-v490-corrected-reconciliation-inner-attempt-terminal-v1"
...
def preflight(args)->dict:
 ...
 if set(contract)!=AUTHORITY_CONTRACT_TOP_KEYS or contract.get("format")!=AUTHORITY_CONTRACT_FORMAT or contract.get("status")!=AUTHORITY_CONTRACT_STATUS or contract.get("seed")!=1635 or contract.get("execution_boundary")!=EXECUTION_BOUNDARY or contains_pending(contract):raise RuntimeError("authority contract schema")
 ...
 source_closure=contract.get("source_closure");expected_roles={"v492_authority_contract","v492_authority_materializer","v492_outer_wrapper","superseded_v490_inner_wrapper","corrected_inner_wrapper","reconciler_r2","outer_execution_wrapper","phase_a_design_contract"}
 ...
 expected_sources={"v492_authority_contract":{"path":str(V492_AUTHORITY_CONTRACT_PATH),"sha256":V492_AUTHORITY_CONTRACT_SHA,"logical_bytes":V492_AUTHORITY_CONTRACT_BYTES},"v492_authority_materializer":{"path":str(V492_AUTHORITY_MATERIALIZER_PATH),"sha256":V492_AUTHORITY_MATERIALIZER_SHA,"logical_bytes":V492_AUTHORITY_MATERIALIZER_BYTES},"v492_outer_wrapper":{"path":str(V492_OUTER_WRAPPER_PATH),"sha256":V492_OUTER_WRAPPER_SHA,"logical_bytes":V492_OUTER_WRAPPER_BYTES},"superseded_v490_inner_wrapper":{"path":str(SUPERSEDED_V490_INNER_PATH),"sha256":SUPERSEDED_V490_INNER_SHA,"logical_bytes":SUPERSEDED_V490_INNER_BYTES},"corrected_inner_wrapper":wrapper_record,"reconciler_r2":{"path":str(R2_PATH),"sha256":R2_SHA,"logical_bytes":R2_BYTES},"outer_execution_wrapper":regular(OUTER_WRAPPER_PATH,observed_sources["outer_execution_wrapper"]["sha256"],observed_sources["outer_execution_wrapper"]["logical_bytes"]),"phase_a_design_contract":{"path":str(PHASE_A_DESIGN_CONTRACT_PATH),"sha256":PHASE_A_DESIGN_CONTRACT_SHA,"logical_bytes":PHASE_A_DESIGN_CONTRACT_BYTES}}
 ...
 if outer_intent.get("format")!="strict-track2-v493-v492-v490-corrected-reconciliation-outer-attempt-intent-v1" or outer_intent.get("status")!="committed_before_corrected_inner_start" or outer_intent.get("command_argv")!=expected_nested_argv or outer_intent.get("command_argv_sha256")!=csha(expected_nested_argv) or outer_intent.get("authority_receipt")!=authority_record:raise RuntimeError("outer intent crossbind")
 v492_authority_record=regular(V492_AUTHORITY_RECEIPT_PATH,V492_AUTHORITY_RECEIPT_SHA,V492_AUTHORITY_RECEIPT_BYTES);v492_authority_tree=tree_with_root(V492_AUTHORITY_ROOT)
 if authority.get("v492_authority_receipt")!=v492_authority_record or contract.get("v492_authority_receipt")!=v492_authority_record or authority.get("v492_authority_registration_tree")!=v492_authority_tree or contract.get("v492_authority_registration_tree")!=v492_authority_tree:raise RuntimeError("v492 authority ancestry")
 if contract.get("v492_authority_contract")!=expected_sources["v492_authority_contract"] or authority.get("v492_authority_contract")!=expected_sources["v492_authority_contract"]:raise RuntimeError("v492 authority contract ancestry")
 v492_materialization_tree=tree_with_root(V492_AUTHORITY_MATERIALIZATION_EVIDENCE_ROOT);v492_process_record=regular(V492_AUTHORITY_MATERIALIZATION_EVIDENCE_ROOT/"process_receipt.json")
 if contract.get("v492_authority_materialization_evidence_tree")!=v492_materialization_tree or authority.get("v492_authority_materialization_evidence_tree")!=v492_materialization_tree or contract.get("v492_authority_materializer_process_receipt")!=v492_process_record or authority.get("v492_authority_materializer_process_receipt")!=v492_process_record:raise RuntimeError("v492 authority materialization ancestry")
 v492_process=json.loads((V492_AUTHORITY_MATERIALIZATION_EVIDENCE_ROOT/"process_receipt.json").read_text())
 if v492_process.get("status")!="passed_exact_once_no_outer_or_inner_execution" or v492_process.get("passed") is not True or v492_process.get("materializer_invocations")!=1 or any(v492_process.get(k)!=0 for k in ("outer_wrapper_invocations","inner_wrapper_invocations","r2_invocations")) or v492_process.get("cleanup",{}).get("reaped") is not True or v492_process.get("cleanup",{}).get("group_empty") is not True:raise RuntimeError("v492 authority materializer process")
 failure_tree=tree_with_root(V492_OUTER_FAILURE_ROOT);terminal_record=regular(V492_OUTER_FAILURE_ROOT/"terminal_receipt.json")
 if authority.get("failed_v492_outer_execution_tree")!=failure_tree or contract.get("v492_outer_failure_tree")!=failure_tree or authority.get("failed_v492_outer_terminal_receipt")!=terminal_record or contract.get("v492_outer_terminal_receipt")!=terminal_record:raise RuntimeError("v492 outer failure ancestry")
 failed_terminal=json.loads((V492_OUTER_FAILURE_ROOT/"terminal_receipt.json").read_text())
 if failed_terminal.get("status")!="failed_no_retry" or failed_terminal.get("passed") is not False or failed_terminal.get("nested_v490_wrapper_invocations")!=1 or failed_terminal.get("transparent_present") is not False or failed_terminal.get("cleanup",{}).get("reaped") is not True or failed_terminal.get("cleanup",{}).get("group_empty") is not True:raise RuntimeError("v492 outer terminal semantics")
...
def immutable_snapshot(context:dict)->dict:
 ...
 tree_specs={"repair":authority["repair_formal_registration_tree"],"static":authority["postregistration_static_registration_tree"],"authority":tree_with_root(AUTHORITY_ROOT),"v492_authority":authority["v492_authority_registration_tree"],"v492_materialization":authority["v492_authority_materialization_evidence_tree"],"v492_outer_failure":authority["failed_v492_outer_execution_tree"]}
...
def synthetic_self_test()->int:
 checks={
  ...
  "authority_top39_check26":len(AUTHORITY_TOP_KEYS)==39 and len(AUTHORITY_CHECK_KEYS)==26,
...
def main()->int:
 ...
 try:
  ...
  terminal={"format":TERMINAL_FORMAT,"status":"passed_exact_one_corrected_inner_and_r2_readonly_reconciliation","passed":True,"attempt_nonce":intent["attempt_nonce"],"wall_seconds":float((time.monotonic_ns()-started)/1e9),"intent":intent_record,"reconciler_r2_source":{"path":str(R2_PATH),"sha256":R2_SHA,"logical_bytes":R2_BYTES},"reconciler_exit_code":0,"reconciler_process_cleanup":cleanup,"reconciler_stdout":regular(ATTEMPT_ROOT/"reconciler_stdout.log"),"reconciler_stderr":regular(ATTEMPT_ROOT/"reconciler_stderr.log"),"transparent_static_receipt":output_record,"transparent_receipt_checks_sha256":transparent["checks_sha256"],"repair_registration_tree":tree_with_root(REPAIR_FORMAL_PATH.parent),"postregistration_static_registration_tree":tree_with_root(STATIC_ROOT),"static_execution_evidence_tree":tree_with_root(STATIC_EXECUTION_EVIDENCE_ROOT),"authority_registration_tree":tree_with_root(AUTHORITY_ROOT),"v492_authority_registration_tree":context["v492_authority_tree"],"failed_v492_outer_execution_tree":context["v492_outer_failure_tree"],"failed_v492_outer_terminal_receipt":context["v492_outer_terminal_record"],"phase_a_design_contract_source":context["phase_contract_record"],"f813_registration_tree_before":context["f813_tree_rooted"],"f813_registration_tree_after":{"root":str(F813_PATH.parent),**f813_after},"f813_exact2_to_sole_exact3":True,"immutable_input_pre_snapshot":core_pre,"immutable_input_post_snapshot":core_post,"immutable_inputs_exactly_equal":True,"retry_authorized":False,**FALSE_AUTHORITIES}
