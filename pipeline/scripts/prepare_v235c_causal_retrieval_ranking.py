...
NAME = "v235c_public_causal_retrieval_ranking_seed1434_20260818"
...
SCRIPT = BASE / "pipeline/scripts/sweep_v235c_causal_retrieval_ranking.py"
...
def main() -> None:
    ...
    payload = {
        "format": "strict-track2-v235c-causal-retrieval-ranking-preregistration-v1",
        ...
        "retry_of": "v235b_public_causal_retrieval_ranking_seed1434_20260818",
        "retry_reason": "pre-score fixed route [B,1] was not broadcast across T",
        "guards": {
