...
RUN = ROOT / "artifacts/strict_track2_official_20260810/run_registry/v427r1_v426_motion_guarded_recursive_seed1577_20260823"
...
def main() -> int:
    ...
    sources = {
        "audit": ROOT / "pipeline/scripts/audit_v427r1_v426_motion_guarded_recursive.py",
    ...
    payload = {
        "format": "strict-track2-v427r1-v426-motion-guarded-recursive-preregistration-v1",
