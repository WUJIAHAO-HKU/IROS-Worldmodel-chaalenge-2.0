...
"$PY" "$ROOT/pipeline/scripts/prepare_v238_phase_transport_ranking.py" \
...
"$PY" "$ROOT/pipeline/scripts/sweep_v238_phase_transport_ranking.py" \
...
echo V238_PHASE_TRANSPORT_RANKING_COMPLETE
