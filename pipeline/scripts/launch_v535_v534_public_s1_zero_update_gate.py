#!/usr/bin/env python3
"""Sole launcher for the v535 public-S1 plus zero-update gate boundary."""
...
SEED=1668
PATHS={
 "contract":"/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/v535_v534_public_s1_zero_update_gate_execution_authority_contract.json",
 "preregistration":"/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/v535_v534_public_s1_zero_update_gate_preregistration.json",
 "manifest":"/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/v535_v534_public_s1_zero_update_gate_manifest.json",
 "evaluator_source":"/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/evaluate_v535_v534_public_s1_zero_update_gate.py",
 "auditor_source":"/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/audit_v535_v534_public_s1_zero_update_gate.py",
 "launcher_source":"/root/autodl-tmp/IROS_WAM_2.0 challenge/pipeline/scripts/launch_v535_v534_public_s1_zero_update_gate.py",
 "authority_receipt":"/root/autodl-tmp/IROS_WAM_2.0 challenge/artifacts/strict_track2_joint_augmentation_20260810/v535_v534_public_s1_zero_update_gate_execution_authority_seed1668_20260827/authority_receipt.json",
...
def run(argv=None):
 ...
 try:
  spec=importlib.util.spec_from_file_location("v535_public_s1_evaluator",args.evaluator_source); module=importlib.util.module_from_spec(spec); spec.loader.exec_module(module)
