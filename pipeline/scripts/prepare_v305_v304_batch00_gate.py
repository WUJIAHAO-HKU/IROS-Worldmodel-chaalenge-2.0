#!/usr/bin/env python3
"""Preregister the first public-only gate for the frozen v304 candidate."""
...
def main() -> None:
    ...
    assert training_prereg["world_model"]["model_version"].startswith("track2-v301-")
    ...
    record = {
        ...
        "purpose": (
            ...
            "against the preregistered v301 world model"
        ),
