...
RUN="$J/v389r1_public_recursive_phase_classifier_seed1550_20260823"
...
taskset -c 0-11 "$PY" "$ROOT/pipeline/scripts/train_v389_public_recursive_phase_classifier.py" \
