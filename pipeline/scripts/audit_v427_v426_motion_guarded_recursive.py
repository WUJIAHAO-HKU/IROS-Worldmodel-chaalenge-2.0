...
def main():
    ...
    if json.loads(args.preregistration.read_text()).get("format")!="strict-track2-v427-v426-motion-guarded-recursive-preregistration-v1": raise RuntimeError("wrong v427 preregistration")
    ...
    report={"format":"strict-track2-v427-v426-motion-guarded-recursive-gate-v1","created_at":datetime.now(timezone.utc).isoformat(),
