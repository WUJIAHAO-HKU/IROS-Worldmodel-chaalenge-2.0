#!/usr/bin/env python3
"""Run the frozen v385 fidelity audit against the v390 runtime/schema."""
...
def main() -> int:
    ...
    if payload.get("format") != "strict-track2-v390-continuous-phase-clean-reanchor-preregistration-v1":
        raise RuntimeError("wrong v390 preregistration")
    ...
    report["format"] = "strict-track2-v390-recursive-reward-causal-gate-v1"
