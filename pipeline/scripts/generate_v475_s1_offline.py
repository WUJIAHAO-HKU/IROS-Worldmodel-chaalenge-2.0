#!/usr/bin/env python3
"""One-shot v475 serial-v169 public S1 generator; selection is immutable action-only input."""
...
OUTPUT_FORMAT="strict-track2-v475-s1-offline-inputs-v1"
...
def main():
 ...
 if a.output.exists() or a.report.exists():raise FileExistsError("v475 S1 output exists")
 ...
 rgb={"independent_v169_frames":generated["independent_v169"],"same_request_v169_frames":generated["same_request_v169"],"v475_true_frames":generated["v475_true"],"v475_action_override_frames":generated["v475_override"],"target_frames":target,"left_same_request_scalar_v169_frames":left_base,"left_v475_frames":left_out}
 ...
 rewards={"independent_v169_reward":score(reward,rgb["independent_v169_frames"],prompts,device,a.reward_batch_size),"v475_true_reward":score(reward,rgb["v475_true_frames"],prompts,device,a.reward_batch_size),"target_reward":score(reward,target,prompts,device,a.reward_batch_size)}
