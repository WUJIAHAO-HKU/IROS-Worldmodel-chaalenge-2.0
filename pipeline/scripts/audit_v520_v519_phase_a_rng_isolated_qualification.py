#!/usr/bin/env python3
"""Independent v520 auditor for exact-eight, per-call RNG-isolated qualification."""
...
def validate_precleanup(root):
    ...
    if ar.get("format")!="strict-track2-v520-v519-rng-isolated-cache-worker-receipt-v1" or br.get("format")!="strict-track2-v520-v519-rng-isolated-cache-worker-receipt-v1" or ar.get("passed") is not True or br.get("passed") is not True or ar.get("role")!="A" or br.get("role")!="B":raise RuntimeError("fresh process receipts")
    for identity in (ai,bi):
