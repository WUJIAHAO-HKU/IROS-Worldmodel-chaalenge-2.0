#!/usr/bin/env python3
"""Independent data-only audit of staged v539 public-S1/zero-update evidence."""
...
def audit_staged(root: Path, manifest: dict, baseline_model: dict, rng_entry: dict) -> dict:
    ...
    with (root/"public_s1_events.ndjson").open("r",encoding="utf-8") as stream:
        for ordinal,line in enumerate(stream):
            ...
            if (
                ...
                or row["isolated_torch_seed"]!=1670*1000+ordinal
    ...
    checks={
        ...
        "zero_trace_schema":trace.get("format")=="strict-track2-v539-v535-zero-update-trace-v1" and type(trace.get("stage_count")) is int and trace["stage_count"]==len(trace.get("stages",[]))==46,
