...
run="artifacts/strict_track2_joint_augmentation_20260810/v341_v340_public_holdout_recursive_seed1510_20260822"
...
/root/miniconda3/envs/go1/bin/python pipeline/scripts/prepare_v341_v340_public_holdout_recursive.py
exec taskset -c 0-7 /root/miniconda3/envs/go1/bin/python \
  pipeline/scripts/audit_v341_v340_public_holdout_recursive.py \
